...
public class PromiseStatusCollectionResource extends ResourceContextHolder implements KeyValueResource<Long, Status>
{
  ...
  public Promise<List<Status>> getPublicTimeline(@Context PagingContext pagingContext)
  {
  ...
  public Promise<List<Status>> getUserTimeline(@Optional("true") @QueryParam("includeReplies") Boolean includeReplies, @Context(defaultCount = 100, defaultStart = 10) PagingContext pagingContext)
  {
    throw new AssertionError("should be mocked");
  }
