...
public class StatusCollectionResource extends CollectionResourceTemplate<Long,Status>
{
  ...
  public List<Status> getUserTimeline(@Optional("true") @QueryParam("includeReplies") Boolean includeReplies, @Context(defaultCount = 100, defaultStart = 10) PagingContext pagingContext)
  {
    return null;
  }
