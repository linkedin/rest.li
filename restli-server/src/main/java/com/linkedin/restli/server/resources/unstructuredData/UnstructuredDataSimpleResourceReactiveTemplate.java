...
/**
 * Base {@link UnstructuredDataSimpleResourceReactive} implementation. All implementations should extend this.
 */
@RestLiTemplate(expectedAnnotation = RestLiSimpleResource.class)
public class UnstructuredDataSimpleResourceReactiveTemplate extends ResourceContextHolder implements UnstructuredDataSimpleResourceReactive
{
}
