...
/**
 * Base {@link UnstructuredDataSimpleResource} implementation. All implementations should extend this.
 */
@RestLiTemplate(expectedAnnotation = RestLiSimpleResource.class)
public class UnstructuredDataSimpleResourceAsyncTemplate extends ResourceContextHolder implements UnstructuredDataSimpleResourceAsync
{
}
