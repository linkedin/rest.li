...
/**
 * A request handler for {@link StreamRequest}s that returns fully-buffered RestLiResponse as the result.
 *
 * @see com.linkedin.r2.transport.common.StreamRequestHandler
 */
public interface StreamToRestLiRequestHandler
{
   ...
   *
   * @see com.linkedin.r2.transport.common.StreamRequestHandler#handleRequest(StreamRequest, RequestContext, Callback)
   */
  void handleRequestWithRestLiResponse(StreamRequest request, RequestContext requestContext, Callback<RestLiResponse> callback);
}
