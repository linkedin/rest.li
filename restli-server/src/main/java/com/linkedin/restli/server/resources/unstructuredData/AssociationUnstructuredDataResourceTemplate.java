...
/**
 * Base {@link AssociationUnstructuredDataResource} implementation. All implementations should extend this.
 */
@RestLiTemplate(expectedAnnotation = RestLiAssociation.class)
public class AssociationUnstructuredDataResourceTemplate extends ResourceContextHolder implements AssociationUnstructuredDataResource
{
}