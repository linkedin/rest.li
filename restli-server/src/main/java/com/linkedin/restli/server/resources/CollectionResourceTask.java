 ...
 * @author kparikh
 */
public interface CollectionResourceTask<K, V extends RecordTemplate> extends
    BaseResource,
    KeyValueResource<K, V>
{
   ...
   */
  Task<CreateResponse> create(V entity);
   ...
   */
  Task<Map<K, V>> batchGet(Set<K> ids);
   ...
   */
  Task<BatchUpdateResult<K, V>> batchUpdate(BatchUpdateRequest<K, V> entities);
   ...
   * @return - update results
   */
  Task<BatchUpdateResult<K, V>> batchUpdate(BatchPatchRequest<K, V> patches);
   ...
   */
  Task<BatchCreateResult<K, V>> batchCreate(BatchCreateRequest<K, V> entities);
   ...
   */
  Task<BatchUpdateResult<K, V>> batchDelete(BatchDeleteRequest<K, V> ids);
   ...
   */
  Task<UpdateResponse> update(K key, V entity);
   ...
   * @return the status or null if for a default, 204 No Content response
   */
  Task<UpdateResponse> update(K key, PatchRequest<V> patch);
   ...
   * @return the status or null if for a default, 204 No Content response
   */
  Task<UpdateResponse> delete(K key);
