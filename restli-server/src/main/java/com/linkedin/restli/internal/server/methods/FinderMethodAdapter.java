...
* @version $Revision: $
*/
public class FinderMethodAdapter implements RestLiMethodAdapter
{
  ...
  private PartialRestResponse buildResponseImpl(final RestRequest request,
                                                final RoutingResult routingResult,
                                 ...
                                 final RestRequest request)
  {
    ...
    return ArgumentBuilder.buildArgs(new Object[0], parameters, context);
  }
