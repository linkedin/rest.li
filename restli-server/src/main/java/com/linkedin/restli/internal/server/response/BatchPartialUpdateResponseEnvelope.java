...
/**
 * Contains response data for {@link ResourceMethod#BATCH_PARTIAL_UPDATE}.
 *
 * @author gye
 */
public class BatchPartialUpdateResponseEnvelope extends BatchResponseEnvelope
{
  /**
  ...
  {
    return ResourceMethod.BATCH_PARTIAL_UPDATE;
  }
}
