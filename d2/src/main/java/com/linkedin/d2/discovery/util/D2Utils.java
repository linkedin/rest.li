...
public class D2Utils
{
  ...
  public static final String USR_DIR_SYS_PROPERTY = "user.dir";
  public static final String SPARK_APP_NAME = "spark.app.name";
  public static final String APP_NAME = "com.linkedin.app.name";
  public static final String SAMZA_CONTAINER_NAME = "samza.container.name";
  ...
  public static String getAppIdentityName(Properties sysProps, Map<String, String> envVars)
  {
    ...
    if (userDir.startsWith(USER_DIR_EXPORT_CONTENT_PREFIX))
    {
      ...
      List<String> parts = Arrays.stream(userDir.split("/"))
          // remove empty parts generated by leading and trailing slashes, e.g: /opt/flink/ becomes ["", "opt", "flink", ""]
          .filter(p -> !p.isEmpty())
