...
public class D2ClientConfig
{
  ...
  public Integer xdsStreamRetryMaxBackoffSeconds = null;
  ...
  D2ClientConfig(String zkHosts,
                 ...
                 Integer xdsStreamRetryMaxBackoffSeconds)
  {
    ...
    this.xdsStreamRetryMaxBackoffSeconds = xdsStreamRetryMaxBackoffSeconds;
  }
}
