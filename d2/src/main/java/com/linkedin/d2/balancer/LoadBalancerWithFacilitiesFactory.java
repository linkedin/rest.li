 ...
 */
public abstract class LoadBalancerWithFacilitiesFactory
{
   ...
   */
  public abstract LoadBalancerWithFacilities create(D2ClientConfig config);

  public void setIsLiRawD2Client(boolean isRawD2Client)
  {
    this.isLiRawD2Client = isRawD2Client;
  }
