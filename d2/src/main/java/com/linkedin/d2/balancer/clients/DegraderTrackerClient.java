 ...
 */
public class DegraderTrackerClient extends TrackerClientImpl
{

  private final Map<Integer, PartitionState> _partitionStates;

  public DegraderTrackerClient(URI uri, Map<Integer, PartitionData> partitionDataMap, TransportClient wrappedClient)
  {
