...
public class BoundedLoadConsistentHashTest
{
  ...
  private static final double BOUNDED_LOAD_BALANCE_FACTOR = 1.25;
  ...
  private DegraderLoadBalancerStrategyConfig getConfig(String hashAlgorithm)
  {
    return new DegraderLoadBalancerStrategyConfig(1000, DegraderLoadBalancerStrategyConfig.DEFAULT_UPDATE_ONLY_AT_INTERVAL,
        ...
        BOUNDED_LOAD_BALANCE_FACTOR, null,
  ...
  public void testCapacityOneItem(RingFactory<URI> ringFactory)
  {
    ...
    _loadMap.put(uri, 10);
    BoundedLoadConsistentHashRing<URI> test = new BoundedLoadConsistentHashRing<>(ringFactory, _pointsMap, createCallTrackerMap(_loadMap), BOUNDED_LOAD_BALANCE_FACTOR);

    test.get(0);

    int totalCapacity = (int) Math.ceil(11 * BOUNDED_LOAD_BALANCE_FACTOR);
  ...
  public void testCapacityTwoItemsEqualWeight(RingFactory<URI> ringFactory)
  {
    ...
    int totalCapacity = (int) Math.ceil((3 + 5 + 1) * BOUNDED_LOAD_BALANCE_FACTOR);
  ...
  public void testCapacityTwoItemsUnequalWeight(RingFactory<URI> ringFactory)
  {
    ...
    int totalCapacity = (int) Math.ceil((3 + 4 + 1) * BOUNDED_LOAD_BALANCE_FACTOR);
  ...
  public void testCapacityMultipleItemsEqualWeight(RingFactory<URI> ringFactory)
  {
    ...
    assertEquals(totalCapacity, (int) Math.ceil(301 * BOUNDED_LOAD_BALANCE_FACTOR));
  }
  ...
  public void testCapacityMultipleItemsUnequalWeight(RingFactory<URI> ringFactory)
  {
    ...
    int totalCapacity = (int) Math.ceil(1001 * BOUNDED_LOAD_BALANCE_FACTOR);
  ...
  public void testIteratorOneItem(RingFactory<URI> ringFactory)
  {
    ...
    Ring<URI> ring = new BoundedLoadConsistentHashRing<>(ringFactory, _pointsMap, createCallTrackerMap(_loadMap), BOUNDED_LOAD_BALANCE_FACTOR);
  ...
  public void testStickyOrdering(RingFactory<URI> ringFactory)
  {
    ...
    for (int i = 0; i < TEST_ITERATION_NUMBER; i++)
    {
      ...
      Ring<URI> firstRing = new BoundedLoadConsistentHashRing<>(ringFactory, _pointsMap, createCallTrackerMap(_loadMap), BOUNDED_LOAD_BALANCE_FACTOR);
      Iterator<URI> firstIter = firstRing.getIterator(key);

      Ring<URI> secondRing = new BoundedLoadConsistentHashRing<>(ringFactory, _pointsMap, createCallTrackerMap(_loadMap), BOUNDED_LOAD_BALANCE_FACTOR);
  ...
  public void testThreadSafe(RingFactory<URI> ringFactory)
  {
    ...
    BoundedLoadConsistentHashRing<URI> test = new BoundedLoadConsistentHashRing<>(ringFactory, _pointsMap, callTrackerMap, BOUNDED_LOAD_BALANCE_FACTOR);
