  ...
  public TrackerClient getClient(String serviceName, URI uri)
  {
    if (_partitionDescriptions.get(uri) != null)
    {
      ...
      else
      {
        ...
        _trackerClients.putIfAbsent(uri, new DegraderTrackerClient(uri, _partitionDescriptions.get(uri), null, new SettableClock(), null, 20, TrackerClientImpl.DEFAULT_ERROR_STATUS_PATTERN));
      }
