...
public class TestXdsClientImpl {
  ...
  private static final XdsD2.Node NODE_WITH_DATA = createNodeWithData(DATA, System.currentTimeMillis() - TEN_MINS);
  private static final XdsD2.Node NODE_WITH_DATA2 = createNodeWithData(DATA2, System.currentTimeMillis() - TEN_MINS);
  ...
  private static final List<Resource> NODE_RESOURCES_WITH_DATA1 = Collections.singletonList(Resource.newBuilder()
      .setVersion(VERSION1)
      .setName(SERVICE_RESOURCE_NAME)
      .setResource(PACKED_NODE_WITH_DATA)
      .build());
  private static final List<Resource> NODE_RESOURCES_WITH_DATA2 = Collections.singletonList(Resource.newBuilder()
      .setVersion(VERSION2)
      .setName(SERVICE_RESOURCE_NAME)
      .setResource(PACKED_NODE_WITH_DATA2)
      .build());
  ...
  private static final List<Resource> NODE_RESOURCES_WITH_NULL_RESOURCE_FIELD = Collections.singletonList(
      Resource.newBuilder()
          .setVersion(VERSION1)
          .setName(SERVICE_RESOURCE_NAME)
          .setResource(PACKED_NODE_WITH_EMPTY_DATA)
          .build());

  private static final XdsD2.D2ClusterOrServiceName CLUSTER_NAME_DATA =
      XdsD2.D2ClusterOrServiceName.newBuilder().setClusterName(CLUSTER_NAME).build();
  private static final XdsD2.D2ClusterOrServiceName SERVICE_NAME_DATA =
      XdsD2.D2ClusterOrServiceName.newBuilder().setServiceName(SERVICE_NAME).build();
  private static final XdsD2.D2ClusterOrServiceName SERVICE_NAME_DATA_2 =
      XdsD2.D2ClusterOrServiceName.newBuilder().setServiceName(SERVICE_NAME_2).build();
  private static final XdsD2.D2ClusterOrServiceName NAME_DATA_WITH_NULL =
      XdsD2.D2ClusterOrServiceName.newBuilder().build();
  ...
  private static final List<Resource> SERVICE_NAME_DATA_RESOURCES = Arrays.asList(Resource.newBuilder()
      .setVersion(VERSION1)
      .setName(SERVICE_RESOURCE_NAME)
      .setResource(PACKED_SERVICE_NAME_DATA)
      .build(), Resource.newBuilder()
      .setVersion(VERSION1)
      .setName(SERVICE_RESOURCE_NAME_2)
      .setResource(PACKED_SERVICE_NAME_DATA_2)
      .build());
  private static final List<Resource> NULL_NAME_RESOURCES =
      Arrays.asList(Resource.newBuilder().setVersion(VERSION1).setName(CLUSTER_RESOURCE_NAME).build(),
          Resource.newBuilder()
              .setVersion(VERSION1)
              .setName(SERVICE_RESOURCE_NAME)
              .setResource(PACKED_NAME_DATA_WITH_NULL)
              .build());

  private static final XdsD2.D2URI D2URI_1 =
      createD2URIWithData(URI1, CLUSTER_NAME, VERSION1, null, System.currentTimeMillis() - TEN_MINS);
  private static final XdsD2.D2URI D2URI_1_1 =
      createD2URIWithData(URI1, CLUSTER_NAME, VERSION2, Collections.singletonMap(0, 2.0),
          System.currentTimeMillis() - TEN_MINS);
  private static final XdsD2.D2URI D2URI_2 =
      createD2URIWithData(URI2, CLUSTER_NAME, VERSION1, null, System.currentTimeMillis() - TEN_MINS);
  ...
  private static final XdsD2.D2URIMap D2_URI_MAP_WITH_DATA1 =
      XdsD2.D2URIMap.newBuilder().putUris(URI1, D2URI_1).build();
  private static final XdsD2.D2URIMap D2_URI_MAP_WITH_DATA2 =
      XdsD2.D2URIMap.newBuilder().putUris(URI1, D2URI_1_1) // updated uri1
  ...
  private static final D2URIMapUpdate D2_URI_MAP_UPDATE_WITH_EMPTY_MAP =
      new D2URIMapUpdate(Collections.emptyMap(), true);
  ...
  private static final List<Resource> URI_MAP_RESOURCE_WITH_DATA2 = Collections.singletonList(Resource.newBuilder()
      ...
      .build());
  private static final List<Resource> EMPTY_URI_MAP_RESOURCE = Collections.singletonList(Resource.newBuilder()
      .setVersion(VERSION2)
      .setName(CLUSTER_RESOURCE_NAME)
  ...
  private static final DiscoveryResponseData RESPONSE_D2URI1 = new DiscoveryResponseData(D2_URI,
      Collections.singletonList(
          Resource.newBuilder().setVersion(VERSION1).setName(URI_URN1).setResource(Any.pack(D2URI_1)).build()), null,
      NONCE, null);
  private static final DiscoveryResponseData RESPONSE_D2URI1_WITH_NON_LAST_NONCE = new DiscoveryResponseData(D2_URI,
      Collections.singletonList(
          Resource.newBuilder().setVersion(VERSION1).setName(URI_URN1).setResource(Any.pack(D2URI_1)).build()), null,
      NON_LAST_NONCE, null);
  private static final DiscoveryResponseData RESPONSE_D2URI2_DELETE_URI1 = new DiscoveryResponseData(D2_URI,
      Collections.singletonList(
          Resource.newBuilder().setVersion(VERSION1).setName(URI_URN2).setResource(Any.pack(D2URI_2)).build()),
  ...
  private static final DiscoveryResponseData DISCOVERY_RESPONSE_NODE_RESOURCE_IS_NULL = new DiscoveryResponseData(NODE,
      Collections.singletonList(Resource.newBuilder().setVersion(VERSION1).setName(SERVICE_RESOURCE_NAME)
          // not set resource field
          .build()), null, NONCE, null);
  ...
  private static final DiscoveryResponseData DISCOVERY_RESPONSE_URI_MAP_RESOURCE_IS_NULL =
      new DiscoveryResponseData(D2_URI_MAP,
  ...
  private static final DiscoveryResponseData DISCOVERY_RESPONSE_NODE_DATA_WITH_REMOVAL =
      new DiscoveryResponseData(NODE, Collections.emptyList(), Collections.singletonList(SERVICE_RESOURCE_NAME), NONCE,
          null);
  private static final DiscoveryResponseData DISCOVERY_RESPONSE_URI_MAP_DATA_WITH_REMOVAL =
      new DiscoveryResponseData(D2_URI_MAP, Collections.emptyList(), Collections.singletonList(CLUSTER_RESOURCE_NAME),
          NONCE, null);
  ...
  private static final DiscoveryResponseData DISCOVERY_RESPONSE_URI1_DATA_WITH_REMOVAL_NON_LAST_NONCE =
      new DiscoveryResponseData(D2_URI, Collections.emptyList(), Collections.singletonList(URI_URN1), NON_LAST_NONCE,
          null);

  private static final String CLUSTER_GLOB_COLLECTION = "xdstp:///indis.D2URI/" + CLUSTER_NAME + "/*";

  public static final String CALLEES_RESOURCE_NAME = "/d2/callees/" + SERVICE_NAME;
  //  public static final String CALLEES_RESOURCE_NAME_2 = "/d2/callees/" + SERVICE_NAME_2;
  private static final XdsD2.D2CalleeServices CALLEES_DATA_1 =
      XdsD2.D2CalleeServices.newBuilder().addServices(SERVICE_NAME_2).build();
  private static final XdsD2.D2CalleeServices CALLEES_DATA_2 =
      XdsD2.D2CalleeServices.newBuilder().addServices(SERVICE_NAME).build();
  private static final XdsD2.D2CalleeServices CALLEES_DATA_EMPTY = XdsD2.D2CalleeServices.newBuilder().build();
  private static final Any PACKED_CALLEES_DATA_1 = Any.pack(CALLEES_DATA_1);
  private static final Any PACKED_CALLEES_DATA_2 = Any.pack(CALLEES_DATA_2);
  private static final Any PACKED_CALLEES_DATA_EMPTY = Any.pack(CALLEES_DATA_EMPTY);
  public static final XdsClient.D2CalleesUpdate CALLEES_UPDATE_1 = new XdsClient.D2CalleesUpdate(CALLEES_DATA_1);
  public static final XdsClient.D2CalleesUpdate CALLEES_UPDATE_2 = new XdsClient.D2CalleesUpdate(CALLEES_DATA_2);
  private static final List<Resource> CALLEES_RESOURCES_WITH_DATA1 = Collections.singletonList(Resource.newBuilder()
      .setVersion(VERSION1)
      .setName(CALLEES_RESOURCE_NAME)
      .setResource(PACKED_CALLEES_DATA_1)
      .build());
  private static final List<Resource> CALLEES_RESOURCES_WITH_DATA2 = Collections.singletonList(Resource.newBuilder()
      .setVersion(VERSION2)
      .setName(CALLEES_RESOURCE_NAME)
      .setResource(PACKED_CALLEES_DATA_2)
      .build());
  private static final List<Resource> CALLEES_RESOURCES_WITH_EMPTY_DATA = Collections.singletonList(
      Resource.newBuilder()
          .setVersion(VERSION1)
          .setName(CALLEES_RESOURCE_NAME)
          .setResource(PACKED_CALLEES_DATA_EMPTY)
          .build());
  private static final DiscoveryResponseData DISCOVERY_RESPONSE_CALLEES_DATA1 =
      new DiscoveryResponseData(D2_CALLEES, CALLEES_RESOURCES_WITH_DATA1, null, NONCE, null);
  private static final DiscoveryResponseData DISCOVERY_RESPONSE_CALLEES_DATA2 =
      new DiscoveryResponseData(D2_CALLEES, CALLEES_RESOURCES_WITH_DATA2, null, NONCE, null);
  private static final DiscoveryResponseData DISCOVERY_RESPONSE_CALLEES_EMPTY_DATA =
      new DiscoveryResponseData(D2_CALLEES, CALLEES_RESOURCES_WITH_EMPTY_DATA, null, NONCE, null);
  private static final DiscoveryResponseData DISCOVERY_RESPONSE_CALLEES_RESOURCE_IS_NULL =
      new DiscoveryResponseData(D2_CALLEES,
          Collections.singletonList(Resource.newBuilder().setVersion(VERSION1).setName(CALLEES_RESOURCE_NAME).build()),
          null, NONCE, null);
  private static final DiscoveryResponseData DISCOVERY_RESPONSE_WITH_EMPTY_CALLEES_RESPONSE =
      new DiscoveryResponseData(D2_CALLEES, Collections.emptyList(), null, NONCE, null);
  private static final DiscoveryResponseData DISCOVERY_RESPONSE_CALLEES_DATA_WITH_REMOVAL =
      new DiscoveryResponseData(D2_CALLEES, Collections.emptyList(), Collections.singletonList(CALLEES_RESOURCE_NAME),
          NONCE, null);
  ...
  public void testHandleD2NodeResponseWithData(boolean toWatchIndividual, boolean toWatchWildcard) {
    ...
    verify(fixture._wildcardResourceWatcher, times(toWatchWildcard ? 1 : 0)).onChanged(SERVICE_RESOURCE_NAME,
        NODE_UPDATE1);
  ...
  public void testHandleD2NodeUpdateWithEmptyResponse() {
    ...
    fixture.verifyAckSent(1);
    verify(fixture._d2UriSubscriber, times(0)).onData(any(), any(), any());
    verify(fixture._clusterSubscriber, times(0)).onData(any(), any(), any());
    verify(fixture._uriMapWildcardSubscriber, times(0)).onData(any(), any(), any(), any());
  }
  ...
  public Object[][] provideBadNodeDataTestCases() {
    ...
    //    toWatchWildcard --- whether to watch resources with wildcard watcher
    // }
    return new Object[][]{{DISCOVERY_RESPONSE_NODE_RESOURCE_IS_NULL, true, true, false},
  ...
  public void testHandleD2ClusterOrServiceNameEmptyResponse() {
    ...
    fixture.verifyAckSent(1);
    verify(fixture._nameWildcardSubscriber, times(0)).onData(any(), any(), any(), any());
  }
  ...
  public void testHandleD2ClusterOrServiceNameResponseWithBadData() {
    ...
    verify(fixture._wildcardResourceWatcher, times(0)).onChanged(CLUSTER_RESOURCE_NAME, CLUSTER_NAME_DATA_UPDATE);
    verify(fixture._wildcardResourceWatcher, times(0)).onChanged(SERVICE_RESOURCE_NAME, SERVICE_NAME_DATA_UPDATE);
  ...
  public void testHandleD2URIMapResponseWithData(boolean toWatchIndividual, boolean toWatchWildcard) {
    ...
    verify(fixture._wildcardResourceWatcher, times(toWatchWildcard ? 1 : 0)).onChanged(CLUSTER_RESOURCE_NAME,
        D2_URI_MAP_UPDATE_WITH_DATA1);
  ...
  public void testHandleD2URIMapUpdateWithEmptyResponse() {
    ...
    assertEquals(D2_URI_MAP.emptyData(), fixture._clusterSubscriber.getData());
    assertEquals(D2_URI_MAP.emptyData(), fixture._uriMapWildcardSubscriber.getData(CLUSTER_RESOURCE_NAME));
    verify(fixture._uriMapWildcardSubscriber, never()).onAllResourcesProcessed();
    ...
    verify(fixture._clusterSubscriber).onData(any(), any(), any());
    verify(fixture._uriMapWildcardSubscriber).onData(any(), any(), any(), any());
  }
  ...
  public void testHandleD2URIMapUpdateWithBadData(boolean toWatchIndividual, boolean toWatchWildcard) {
    ...
    verify(fixture._wildcardResourceWatcher, times(0)).onChanged(any(), eq(D2_URI_MAP_UPDATE_WITH_DATA1));
  ...
  public void testHandleD2URICollectionResponseWithData() {
    ...
    verify(fixture._wildcardResourceWatcher).onChanged(CLUSTER_RESOURCE_NAME,
        D2_URI_MAP_GLOB_COLLECTION_UPDATE_WITH_DATA1);
    D2URIMapUpdate actualData = (D2URIMapUpdate) fixture._clusterSubscriber.getData();
    // subscriber data should be updated to D2_URI_MAP_UPDATE_WITH_DATA1
    Assert.assertEquals(Objects.requireNonNull(actualData).getURIMap(),
        D2_URI_MAP_GLOB_COLLECTION_UPDATE_WITH_DATA1.getURIMap());
  ...
  public void testHandleD2URICollectionUpdateWithBadData(boolean toWatchIndividual, boolean toWatchWildcard) {
    DiscoveryResponseData badData = new DiscoveryResponseData(D2_URI,
  ...
  public void testResourceSubscriberAddWatcher() {
    ResourceSubscriber subscriber = new ResourceSubscriber(NODE, "foo", null, false);
    ...
    WildcardResourceSubscriber wildcardSubscriber = new WildcardResourceSubscriber(D2_CLUSTER_OR_SERVICE_NAME, false);
  ...
  public void testUpdateResourceVersions() {
    ...
    fixture._xdsClientImpl.handleResponse(DISCOVERY_RESPONSE_NODE_DATA1);
    Assert.assertTrue(
        fixture._resourceVersions.get(NODE).containsKey(SERVICE_RESOURCE_NAME) && fixture._resourceVersions.get(NODE)
            .get(SERVICE_RESOURCE_NAME)
            .equals(VERSION1));

    // validate, node with null resource fields in response, updates the resource version coming in response.
    DiscoveryResponseData responseWithoutResource = new DiscoveryResponseData(NODE,
  ...
  public void testWatchD2Uri() {
    ...
    DiscoveryResponseData badD2URIUpdate = new DiscoveryResponseData(D2_URI,
        Collections.singletonList(Resource.newBuilder().setVersion("bad").setName(URI_URN1)
    ...
    // URI added
    fixture._xdsClientImpl.handleResponse(new DiscoveryResponseData(D2_URI, Collections.singletonList(
        Resource.newBuilder().setVersion("123").setName(URI_URN1).setResource(Any.pack(D2URI_1)).build()), null, NONCE,
        null));
    ...
    // URI deleted
    fixture._xdsClientImpl.handleResponse(
        new DiscoveryResponseData(D2_URI, null, Collections.singletonList(URI_URN1), NONCE, null));
  ...
  public void testTrackLatencyForD2Node(boolean isIrvEnabled) {
    ...
    XdsD2.Node nodeChangedAfter = createNodeWithData(DATA, System.currentTimeMillis() - Time.milliseconds(200));
    List<Resource> resources = Collections.singletonList(Resource.newBuilder()
        .setVersion("3")
        .setName(SERVICE_RESOURCE_NAME)
        .setResource(Any.pack(nodeChangedAfter))
        .build());
  ...
  @DataProvider(name = "provideResponseActionAndIrvEnabled")
  public Object[][] provideResponseActionAndIrvEnabled()
  {
    // Params:
    //    responseAction --- whether the response is a data update or a removal
    //    irvEnabled     --- whether IRV is enabled
    return new Object[][]
        {
            {ResponseAction.UPDATE, false},
            {ResponseAction.REMOVAL, false},
            {ResponseAction.UPDATE, true},
            {ResponseAction.REMOVAL, true}
        };
  }
  @Test(dataProvider = "provideResponseActionAndIrvEnabled")
  private void testGetActiveInitialWaitTime(ResponseAction responseAction, Boolean irvEnabled)
  {
    XdsClientImplFixture fixture = new XdsClientImplFixture(true, irvEnabled);
    XdsClientImpl xdsClient = fixture._xdsClientImpl;
    fixture.watchAllResourceAndWatcherTypes();
    fixture.setAllSubscribersSubscribedAt(System.currentTimeMillis() - TEN_MINS);
    ...
    // wait time anymore.
    fixture.verifySubscribersState(FETCHED);
    assertEquals( 0L, xdsClient.getActiveInitialWaitTimeMillis());

    // After reconnect all subscribers go to PENDING_AFTER_RECONNECT state.
    fixture.reconnect();
    fixture.verifySubscribersState(PENDING_AFTER_RECONNECT);
    if (irvEnabled)
    {
      // If IRV is enabled, not receiving any data means the existing data is up-to-date, so wait time is 0.
      assertEquals( 0L, xdsClient.getActiveInitialWaitTimeMillis());
  ...
  // Test the cases that no init data is received (wildcard subscribers haven't received all batches)
  @Test(dataProvider = "provideIrvEnabled")
  public void testGetActiveInitialWaitTimeWithPendingInitData(Boolean irvEnabled)
  {
    XdsClientImplFixture fixture = new XdsClientImplFixture(false, irvEnabled);
    XdsClientImpl xdsClient = fixture._xdsClientImpl;
    fixture.watchAllResourceAndWatcherTypes();
    fixture.setAllSubscribersSubscribedAt(System.currentTimeMillis() - TEN_MINS);
    // init pending for all 6 subscribers as verified in the above test
  ...
  @Test(dataProvider = "providerWatcherFlags")
  public void testHandleD2CalleesResponseWithData(boolean toWatchIndividual, boolean toWatchWildcard) {
    XdsClientImplFixture fixture = new XdsClientImplFixture();
    if (toWatchIndividual) {
      fixture.watchCalleesResource();
    }
    if (toWatchWildcard) {
      fixture.watchCalleesResourceViaWildcard();
    }

    fixture._xdsClientImpl.handleResponse(DISCOVERY_RESPONSE_CALLEES_DATA1);
    fixture.verifyAckSent(1);
    verify(fixture._resourceWatcher, times(toWatchIndividual ? 1 : 0)).onChanged(CALLEES_UPDATE_1);
    verify(fixture._wildcardResourceWatcher, times(toWatchWildcard ? 1 : 0)).onChanged(CALLEES_RESOURCE_NAME,
        CALLEES_UPDATE_1);
    Assert.assertEquals(fixture._calleesSubscriber.getData(), CALLEES_UPDATE_1);
    Assert.assertEquals(fixture._calleesWildcardSubscriber.getData(CALLEES_RESOURCE_NAME), CALLEES_UPDATE_1);

    fixture._xdsClientImpl.handleResponse(DISCOVERY_RESPONSE_CALLEES_DATA2);
    fixture.verifyAckSent(2);
    verify(fixture._resourceWatcher, times(toWatchIndividual ? 1 : 0)).onChanged(CALLEES_UPDATE_2);
    verify(fixture._wildcardResourceWatcher, times(toWatchWildcard ? 1 : 0)).onChanged(CALLEES_RESOURCE_NAME,
        CALLEES_UPDATE_2);
    Assert.assertEquals(fixture._calleesSubscriber.getData(), CALLEES_UPDATE_2);
    Assert.assertEquals(fixture._calleesWildcardSubscriber.getData(CALLEES_RESOURCE_NAME), CALLEES_UPDATE_2);
  }

  @Test
  public void testHandleD2CalleesUpdateWithEmptyResponse() {
    XdsClientImplFixture fixture = new XdsClientImplFixture();
    fixture.watchAllResourceAndWatcherTypes();
    fixture._xdsClientImpl.handleResponse(DISCOVERY_RESPONSE_WITH_EMPTY_CALLEES_RESPONSE);
    fixture.verifyAckSent(1);
    verify(fixture._calleesSubscriber, times(0)).onData(any(), any(), any());
    verify(fixture._calleesWildcardSubscriber, times(0)).onData(any(), any(), any(), any());
  }

  @Test
  public void testHandleD2CalleesResponseWithEmptyData() {
    XdsClientImplFixture fixture = new XdsClientImplFixture();
    fixture.watchAllResourceAndWatcherTypes();
    fixture._xdsClientImpl.handleResponse(DISCOVERY_RESPONSE_CALLEES_EMPTY_DATA);
    fixture.verifyAckSent(1);
    XdsClient.D2CalleesUpdate emptyUpdate = new XdsClient.D2CalleesUpdate(CALLEES_DATA_EMPTY);
    verify(fixture._resourceWatcher).onChanged(emptyUpdate);
    verify(fixture._wildcardResourceWatcher).onChanged(CALLEES_RESOURCE_NAME, emptyUpdate);
    Assert.assertEquals(fixture._calleesSubscriber.getData(), emptyUpdate);
    Assert.assertEquals(fixture._calleesWildcardSubscriber.getData(CALLEES_RESOURCE_NAME), emptyUpdate);
  }

  @Test(dataProvider = "providerWatcherFlags")
  public void testHandleD2CalleesUpdateWithBadData(boolean toWatchIndividual, boolean toWatchWildcard) {
    XdsClientImplFixture fixture = new XdsClientImplFixture();
    if (toWatchIndividual) {
      fixture.watchCalleesResource();
    }
    ...
    fixture._xdsClientImpl.handleResponse(DISCOVERY_RESPONSE_CALLEES_RESOURCE_IS_NULL);
    fixture.verifyAckOrNack(true, 1);
    verify(fixture._resourceWatcher, times(0)).onChanged(any());
    verify(fixture._wildcardResourceWatcher, times(0)).onChanged(any(), any());
    Assert.assertNull(fixture._calleesSubscriber.getData());
    Assert.assertNull(fixture._calleesWildcardSubscriber.getData(CALLEES_RESOURCE_NAME));

    fixture._calleesSubscriber.setData(CALLEES_UPDATE_1);
    fixture._calleesWildcardSubscriber.setData(CALLEES_RESOURCE_NAME, CALLEES_UPDATE_1);
    fixture._xdsClientImpl.handleResponse(DISCOVERY_RESPONSE_CALLEES_RESOURCE_IS_NULL);

    fixture.verifyAckOrNack(true, 2);
    verify(fixture._resourceWatcher, times(0)).onChanged(CALLEES_UPDATE_1);
    verify(fixture._wildcardResourceWatcher, times(0)).onChanged(any(), eq(CALLEES_UPDATE_1));
    Assert.assertEquals(fixture._calleesSubscriber.getData(), CALLEES_UPDATE_1);
    Assert.assertEquals(fixture._calleesWildcardSubscriber.getData(CALLEES_RESOURCE_NAME), CALLEES_UPDATE_1);
  }

  @Test
  public void testHandleD2CalleesResponseWithRemoval() {
    XdsClientImplFixture fixture = new XdsClientImplFixture();
    fixture.watchAllResourceAndWatcherTypes();

    // Test initial removal response initializes empty data
    fixture._xdsClientImpl.handleResponse(DISCOVERY_RESPONSE_CALLEES_DATA_WITH_REMOVAL);
    fixture.verifyAckSent(1);
    XdsClient.D2CalleesUpdate emptyUpdate = new XdsClient.D2CalleesUpdate(CALLEES_DATA_EMPTY);
    Assert.assertEquals(fixture._calleesSubscriber.getData(), emptyUpdate);
    // wildcard subscriber doesn't initialize empty data on removal
    Assert.assertNull(fixture._calleesWildcardSubscriber.getData(CALLEES_RESOURCE_NAME));

    // Test removal response with existing data
    fixture._calleesSubscriber.setData(CALLEES_UPDATE_1);
    fixture._calleesWildcardSubscriber.setData(CALLEES_RESOURCE_NAME, CALLEES_UPDATE_1);
    fixture._xdsClientImpl.handleResponse(DISCOVERY_RESPONSE_CALLEES_DATA_WITH_REMOVAL);
    fixture.verifyAckSent(2);
    verify(fixture._resourceWatcher).onChanged(CALLEES_UPDATE_1);
    verify(fixture._wildcardResourceWatcher, times(2)).onRemoval(CALLEES_RESOURCE_NAME);
    verify(fixture._calleesSubscriber, times(2)).onRemoval();
    verify(fixture._calleesWildcardSubscriber, times(2)).onRemoval(CALLEES_RESOURCE_NAME);
    Assert.assertEquals(fixture._calleesSubscriber.getData(), CALLEES_UPDATE_1);
    Assert.assertNull(fixture._calleesWildcardSubscriber.getData(CALLEES_RESOURCE_NAME));
  }
  ...
  private static void verifyPositiveLagLessThanOneSec(int times, XdsServerMetricsProvider serverMetricsProvider) {
    verify(serverMetricsProvider, times(times)).trackLatency(longThat(new PositiveLagLessThan(Time.seconds(1))));
  }

  private static void verifyLagGreaterThanTenMins(int times, XdsServerMetricsProvider serverMetricsProvider) {
    verify(serverMetricsProvider, times(times)).trackLatency(longThat(new GreaterThan<>(TEN_MINS)));
  }
  ...
  private static final class XdsClientImplFixture {
    ...
    ResourceSubscriber _calleesSubscriber;
    ...
    XdsClientImpl.WildcardResourceSubscriber _calleesWildcardSubscriber;
    ...
    Map<ResourceType, XdsClientImpl.WildcardResourceSubscriber> _wildcardSubscribers =
    ...
    XdsClientImplFixture(boolean useGlobCollections, boolean useIRV) {
      ...
      _nodeSubscriber = spy(new ResourceSubscriber(NODE, SERVICE_RESOURCE_NAME, _xdsClientJmx, useIRV, _clock));
      _clusterSubscriber = spy(new ResourceSubscriber(D2_URI_MAP, CLUSTER_RESOURCE_NAME, _xdsClientJmx, useIRV, _clock));
      _d2UriSubscriber = spy(new ResourceSubscriber(D2_URI, URI_URN1, _xdsClientJmx, useIRV, _clock));
      _calleesSubscriber = spy(new ResourceSubscriber(D2_CALLEES, CALLEES_RESOURCE_NAME, _xdsClientJmx, useIRV, _clock));
      _nodeWildcardSubscriber = spy(new WildcardResourceSubscriber(NODE, useIRV, _clock));
      _uriMapWildcardSubscriber = spy(new WildcardResourceSubscriber(D2_URI_MAP, useIRV, _clock));
      _nameWildcardSubscriber = spy(new WildcardResourceSubscriber(D2_CLUSTER_OR_SERVICE_NAME, useIRV, _clock));
      _calleesWildcardSubscriber = spy(new WildcardResourceSubscriber(D2_CALLEES, useIRV, _clock));
      ...
      for (WildcardResourceSubscriber subscriber : Lists.newArrayList(_nodeWildcardSubscriber,
          _uriMapWildcardSubscriber, _nameWildcardSubscriber, _calleesWildcardSubscriber)) {
      ...
      doNothing().when(_adsStream)
          .sendDiscoveryRequest(_resourceTypesArgumentCaptor.capture(), _resourceNamesArgumentCaptor.capture(),
    ...
    void watchCalleesResource() {
      _calleesSubscriber.addWatcher(_resourceWatcher);
    }

    void watchCalleesResourceViaWildcard() {
      _calleesWildcardSubscriber.addWatcher(_wildcardResourceWatcher);
    }
    ...
    void verifySubscribersState(XdsClientImpl.SubscriberFetchState expected)
    {
  ...
  public static XdsClient.D2CalleesUpdate createCalleesUpdate(XdsD2.D2CalleeServices calleeServices) {
    return new XdsClient.D2CalleesUpdate(calleeServices);
  }
}
