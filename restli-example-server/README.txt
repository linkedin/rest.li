...
1. gradle startExampleServer (CTRL+C to stop). Server is up when you see "Building > :restli-example-server:startServer". You can also run RestLiExamplesServer.main() from Eclipse/IntelliJ. Hit any key (or CTRL+c) to stop the server.
