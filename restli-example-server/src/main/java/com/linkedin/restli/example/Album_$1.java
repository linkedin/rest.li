...
public class Album_$1
    extends Album_$Versioned
{

    private final static Fields _fields = new Fields();
    private final static RecordDataSchema SCHEMA = ((RecordDataSchema) DataTemplateUtil.parseSchema("namespace com.linkedin.restli.example/**An album for Rest.li*/record Album{id:long,urn:string}", SchemaFormatType.PDL));
     ...
     * @see Fields#id
     */
    public Album_$1 setId(Long value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
                return setId(value);
     ...
     * @see Fields#id
     */
    public Album_$1 setId(long value) {
        CheckedUtil.putWithoutChecking(super._map, "id", DataTemplateUtil.coerceLongInput(value));
        _idField = value;
        return this;
    }
     ...
     * @see Fields#urn
     */
    public Album_$1 setUrn(String value, SetMode mode) {
        switch (mode) {
            case DISALLOW_NULL:
                return setUrn(value);
            case REMOVE_OPTIONAL_IF_NULL:
    ...
    @Override
    public Album_$1 clone()
        throws CloneNotSupportedException
    {
        Album_$1 __clone = ((Album_$1) super.clone());
    ...
    @Override
    public Album_$1 copy()
        throws CloneNotSupportedException
    {
        Album_$1 __copy = ((Album_$1) super.copy());
        ...
        implements com.linkedin.data.collections.CheckedMap.ChangeListener<String, Object>
    {
        ...
        private final Album_$1 __objectRef;

        private ChangeListener(Album_$1 reference) {
