...
/**
 * CollectionResource containing all statuses modeled using promise template with result wrappers.
 */
@RestLiCollection(name="statusPromisesWrapped",
    keyName="statusID")
...
public class StatusPromiseResultWrappersResource extends com.linkedin.restli.server.resources.CollectionResourcePromiseTemplate<Long,Status>
{
  /**
   * Gets the status timeline for a given user
   */
  @Finder("user_timeline")
  public Promise<CollectionResult<Status, User>> getUserTimeline(@PagingContextParam PagingContext pagingContext)
  {
    return null;
  }
   ...
   */
  @RestMethod.BatchGet
  public Promise<BatchResult<Long, Status>> batchGetWrapped(Set<Long> ids)
  {
    return null;
  }
   ...
   */
  @RestMethod.Get
  public Promise<GetResult<Status>> getWrapped(Long key)
  {
    return null;
  }
   ...
   */
  @RestMethod.GetAll
  public Promise<CollectionResult<Status, User>> getAllWrapped(@PagingContextParam PagingContext pagingContext)
  {
    return null;
  }
  ...
  public Promise<ActionResult<String>> forward(@ActionParam("to") long userID)
  {
    return null;
  }
}
