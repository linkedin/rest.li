...
/**
 * CollectionResource containing all statuses modeled using Task template.
 */
@RestLiCollection(name="statusTasks",
    keyName="statusID")
...
public class StatusTaskResource extends CollectionResourceTaskTemplate<Long,Status>
{
  /**
   * Gets the status timeline for a given user
   */
  @Finder("user_timeline")
  public Task<List<Status>> getUserTimeline(@PagingContextParam PagingContext pagingContext)
  {
    return null;
  }
   ...
   */
  @Override
  public Task<CreateResponse> create(Status entity) {
    return null;
  }
   ...
   */
  @Override
  public Task<Map<Long, Status>> batchGet(Set<Long> ids)
  {
    return null;
  }
   ...
   */
  @Override
  public Task<Status> get(Long key)
  {
    return null;
  }
   ...
   */
  @Override
  public Task<List<Status>> getAll(@PagingContextParam PagingContext pagingContext)
  {
    return null;
  }
   ...
   */
  @Override
  public Task<UpdateResponse> delete(Long key)
  {
    return null;
  }
   ...
   */
  @Override
  public Task<UpdateResponse> update(Long key, PatchRequest<Status> request)
  {
    return null;
  }
  ...
  public Task<String> forward(@ActionParam("to") long userID)
  {
    return null;
  }
}
