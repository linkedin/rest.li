...
/**
 * CollectionResource containing all statuses modeled using sync collection template with result wrappers.
 */
@RestLiCollection(name="statusesWrapped",
    keyName="statusID")
...
public class StatusCollectionResultWrappersResource extends CollectionResourceTemplate<Long,Status>
{
  /**
   * Gets the status timeline for a given user
   */
  @Finder("user_timeline")
  public CollectionResult<Status, User> getUserTimeline(@PagingContextParam PagingContext pagingContext)
  {
    return null;
  }
  ...
  public BatchFinderResult<Status, Status, User> batchFindStatuses(@QueryParam("criteria") Status[] criteria)
  {
    return null;
  }
   ...
   */
  @RestMethod.BatchGet
  public BatchResult<Long, Status> batchGetWrapped(Set<Long> ids)
  {
    return null;
  }
   ...
   */
  @RestMethod.Get
  public GetResult<Status> getWrapped(Long key)
  {
    return null;
  }
   ...
   */
  @RestMethod.GetAll
  public CollectionResult<Status, User> getAllWrapped(@PagingContextParam PagingContext pagingContext)
  {
    return null;
  }
  ...
  public ActionResult<String> forward(@ActionParam("to") long userID)
  {
    return null;
  }
}
