...
/**
 * Action parameter binding method specification for action request builder.
 *
 * @author Min Chen
 */
public class ActionParamBindingMethodSpec extends RequestBuilderMethodSpec
{
  ...
  public ActionParamBindingMethodSpec()
  {
    super();
  }

  public ActionParamBindingMethodSpec(String methodName)
  {
    super(methodName);
  }
