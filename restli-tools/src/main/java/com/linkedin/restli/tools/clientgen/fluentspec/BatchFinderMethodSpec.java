...
public class BatchFinderMethodSpec extends MethodSpec
{
  private final BatchFinderSchema _finderSchema;

  public BatchFinderMethodSpec(BatchFinderSchema finderSchema, BaseResourceSpec root)
  {
    super(root);
  ...
  {
    return ResourceMethod.BATCH_FINDER.name();
  }
