 ...
 */
@RestLiCollection(name = "subsubgreetingsInsubGreeting", namespace = "com.linkedin.restli.examples.greetings.client", parent = CollectionUnderCollectionResource.class)
public class ColectionUnderCollectionUnderCollectionResource extends CollectionResourceTemplate<Long, Greeting>
{
  private static final GreetingsResourceImpl _impl = new GreetingsResourceImpl("subsubgreetingInsubGreeting");
