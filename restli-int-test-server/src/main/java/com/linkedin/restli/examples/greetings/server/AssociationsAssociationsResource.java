...
@RestLiAssociation(name="associationsassociations",
    ...
    assocKeys={@Key(name="anotherSrc", type=String.class),
...
public class AssociationsAssociationsResource extends AssociationResourceTemplate<Message>
{
  ...
  public List<Message> assocKeyFinder(@AssocKeyParam("anotherSrc") String anotherSrc)
  {
    return Collections.emptyList();
  }

  @Finder("assocKeyFinderOpt")
  public List<Message> assocKeyFinderOpt(@Optional @AssocKeyParam("anotherSrc") String anotherSrc)
  {
    return Collections.emptyList();
  }
  ...
  public BatchFinderResult<MessageCriteria, Message, Empty> searchMessages(@AssocKeyParam("anotherSrc") String anotherSrc, @PagingContextParam PagingContext context,
