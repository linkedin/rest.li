 ...
 */
@RestLiSimpleResource(name = "subGreetingSimpleUnstructuredData", namespace = "com.linkedin.restli.examples.greetings.client",
    parent = RootSimpleResource.class)
public class UnstructuredDataSimpleResourceUnderSimpleResource extends UnstructuredDataSimpleResourceTemplate
{
  @Override
