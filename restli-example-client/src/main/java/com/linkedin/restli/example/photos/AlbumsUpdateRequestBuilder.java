...
public class AlbumsUpdateRequestBuilder
    extends UpdateRequestBuilderBase<Long, Album_$Versioned, AlbumsUpdateRequestBuilder>
{


    public AlbumsUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
        super(baseUriTemplate, Album_$Versioned.class, resourceSpec, requestOptions);
    }

    @Override
    public AlbumsUpdateRequestBuilder input(Album_$Versioned entity) {
    ...
    public static ValidationResult validateInput(Album_$Versioned input) {
        ...
        RestLiDataValidator validator = new RestLiDataValidator(annotations, Album_$Versioned.class, ResourceMethod.UPDATE);
