...
public class AlbumsGetRequestBuilder
    extends GetRequestBuilderBase<Long, Album_$Versioned, AlbumsGetRequestBuilder>
{


    public AlbumsGetRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
