...
public class TestHttp2With204AndException extends RestLiIntegrationTest{
  @BeforeClass
  public void initClass() throws Exception
  {
    Map<String, String> transportProperties = new HashMap<>();
    final String httpRequestTimeout = System.getProperty("test.httpRequestTimeout", "100000");
    transportProperties.put(HttpClientFactory.HTTP_REQUEST_TIMEOUT, httpRequestTimeout);
    transportProperties.put(HttpClientFactory.HTTP_PROTOCOL_VERSION, HTTP_2);
  ...
  @Test
  public void test204ExceptionWithHttp2() throws Exception
  {
    try
    {
