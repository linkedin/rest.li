...
public class Http2NettyResponseOnlyStreamClient extends AbstractNettyResponseOnlyStreamClient
{
  /**
   ...
   */
  public Http2NettyResponseOnlyStreamClient(EventLoopGroup eventLoopGroup, ScheduledExecutorService scheduler,
