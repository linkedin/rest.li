 ...
 *
 * IMPORTANT BUG FIX: This file needs to be deleted and renamed its references to {@link Http2ClientUpgradeCodec}
 * once Netty is upgraded to 4.1.40. The fix present in this file is already merged to Netty release branch 4.1.40
 * More details about this issue can be found @ https://github.com/netty/netty/issues/9495
 */
@UnstableApi
public class Http2ClientUpgradeCodecTemporaryFix implements HttpClientUpgradeHandler.UpgradeCodec {
    ...
    public Http2ClientUpgradeCodecTemporaryFix(Http2FrameCodec frameCodec, ChannelHandler upgradeToHandler) {
        this(null, frameCodec, upgradeToHandler);
    }

    public Http2ClientUpgradeCodecTemporaryFix(String handlerName, Http2FrameCodec frameCodec, ChannelHandler upgradeToHandler) {
     ...
     */
    public Http2ClientUpgradeCodecTemporaryFix(Http2ConnectionHandler connectionHandler) {
     ...
     * @param connectionHandler the HTTP/2 connection handler
     */
    public Http2ClientUpgradeCodecTemporaryFix(String handlerName, Http2ConnectionHandler connectionHandler) {
    ...
    private Http2ClientUpgradeCodecTemporaryFix(String handlerName, Http2ConnectionHandler connectionHandler, ChannelHandler
