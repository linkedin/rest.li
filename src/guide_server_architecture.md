...
Client</b><br><img src="{{ 'assets/images/RestLiClientServerFlow.png' | relative_url }}">
...
Flow</b><br><img src="{{ 'assets/images/RestLiCodeGen.png' | relative_url }}">

</center>
Let's look at each step:

-   **Step 1**. The first step in building a Rest.li application is to
    define your data schema using [Pegasus Data Schemas](/rest.li/pdl_schema).
