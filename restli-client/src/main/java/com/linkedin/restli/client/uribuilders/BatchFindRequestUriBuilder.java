...
/**
 * A URI builder for constructing URI of a {@link BatchFindRequest}.
 *
 * @author Jiaqi Guan
 */
public class BatchFindRequestUriBuilder extends AbstractRestliRequestUriBuilder<BatchFindRequest<?>>
{
  BatchFindRequestUriBuilder(BatchFindRequest<?> request, String uriPrefix, ProtocolVersion version)
  {
