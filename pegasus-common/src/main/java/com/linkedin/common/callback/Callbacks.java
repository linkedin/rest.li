...
public class Callbacks
{
  ...
  /**
   * Allows to shorten the callback creation by passing a lambda as first parameter,
   * and another callback used just in case of error propagation
   *
   * @param  successCallback
   *           the lambda containing the operation to do onSuccess
   * @param  errorCallback
   *           the callback called in case of exception propagation
   * @return a regular {@link Callback}
   */
