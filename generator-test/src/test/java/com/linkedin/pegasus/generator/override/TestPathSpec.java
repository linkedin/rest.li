...
public class TestPathSpec
{
  ...
  public void testPathSpecs()
  {
    ...
    checkPathSpec(ArrayTest.fields().unionArray().items().EnumFruits(), "/unionArray/*/com.linkedin.pegasus.generator.testpackage.EnumFruits");
    checkPathSpec(ArrayTest.fields().unionArray().items().RecordBar().location(), "/unionArray/*/com.linkedin.pegasus.generator.testpackage.RecordBar/location");
    checkPathSpec(ArrayTest.fields().unionArray().items().FixedMD5(), "/unionArray/*/com.linkedin.pegasus.generator.testpackage.FixedMD5");

    checkPathSpec(CircularImport.fields().a().link().CircularImportA().link(), "/a/link/com.linkedin.pegasus.generator.testpackage.CircularImportA/link");
    checkPathSpec(CircularImport.fields().a().link().CircularImportB().link(), "/a/link/com.linkedin.pegasus.generator.testpackage.CircularImportB/link");
    ...
    checkPathSpec(MapTest.fields().unionMap().values().EnumFruits(), "/unionMap/*/com.linkedin.pegasus.generator.testpackage.EnumFruits");
    checkPathSpec(MapTest.fields().unionMap().values().RecordBar(), "/unionMap/*/com.linkedin.pegasus.generator.testpackage.RecordBar");
    checkPathSpec(MapTest.fields().unionMap().values().FixedMD5(), "/unionMap/*/com.linkedin.pegasus.generator.testpackage.FixedMD5");
  }
