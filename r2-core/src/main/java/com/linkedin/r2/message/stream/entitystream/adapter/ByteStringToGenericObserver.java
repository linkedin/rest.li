...
/**
 * An Observer of ByteString adapted from a ByteString-specific Observer.
 */
class ByteStringToGenericObserver implements com.linkedin.entitystream.Observer<ByteString>
{
  private final Observer _observer;

  ByteStringToGenericObserver(Observer observer)
  {
    _observer = observer;
  }
