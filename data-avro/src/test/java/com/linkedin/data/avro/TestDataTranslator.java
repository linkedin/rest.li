...
public class TestDataTranslator {
  ...
  public void testDataTranslator() throws IOException {
    ...
    String[][][] inputs = {
        ...
        // }
        {
            ...
            {"{ \"intRequired\" : 42 }", "{\"intRequired\":42}"}, {"{ }", "Error processing /intRequired"},
            {"{ \"intRequired\" : null }", "Error processing /intRequired"},
            {"{ \"intRequired\" : \"string\" }", "Error processing /intRequired"}},
        // record with long field
        {{"{\n" + "  \"type\" : \"record\",\n" + "  \"name\" : \"Foo\",\n" + "  \"fields\" : [\n"
            + "    { \"name\" : \"longRequired\", \"type\" : ##T_START \"long\" ##T_END }\n" + "  ]\n" + "}\n"},
            {"{ \"longRequired\" : 42 }", "{\"longRequired\":42}"}, {"{ }", "Error processing /longRequired"},
            {"{ \"longRequired\" : null }", "Error processing /longRequired"},
            {"{ \"longRequired\" : \"string\" }", "Error processing /longRequired"}},
        // record with float field
        {{"{\n" + "  \"type\" : \"record\",\n" + "  \"name\" : \"Foo\",\n" + "  \"fields\" : [\n"
            + "    { \"name\" : \"floatRequired\", \"type\" : ##T_START \"float\" ##T_END }\n" + "  ]\n" + "}\n"},
            {"{ \"floatRequired\" : 42 }", "{\"floatRequired\":42.0}"}, {"{ }", "Error processing /floatRequired"},
            {"{ \"floatRequired\" : null }", "Error processing /floatRequired"},
            {"{ \"floatRequired\" : \"string\" }", "Error processing /floatRequired"}},
        // record with double field
        {{"{\n" + "  \"type\" : \"record\",\n" + "  \"name\" : \"Foo\",\n" + "  \"fields\" : [\n"
            + "    { \"name\" : \"doubleRequired\", \"type\" : ##T_START \"double\" ##T_END }\n" + "  ]\n" + "}\n"},
            {"{ \"doubleRequired\" : 42 }", "{\"doubleRequired\":42.0}"}, {"{ }", "Error processing /doubleRequired"},
            {"{ \"doubleRequired\" : null }", "Error processing /doubleRequired"},
            {"{ \"doubleRequired\" : \"string\" }", "Error processing /doubleRequired"}}, {
        // record with boolean field
        {"{\n" + "  \"type\" : \"record\",\n" + "  \"name\" : \"Foo\",\n" + "  \"fields\" : [\n"
            + "    { \"name\" : \"booleanRequired\", \"type\" : ##T_START \"boolean\" ##T_END }\n" + "  ]\n" + "}\n"},
        {"{ \"booleanRequired\" : true }", "{\"booleanRequired\":true}"},
        {"{ \"booleanRequired\" : false }", "{\"booleanRequired\":false}"},
        {"{ }", "Error processing /booleanRequired"},
        {"{ \"booleanRequired\" : null }", "Error processing /booleanRequired"},
        {"{ \"booleanRequired\" : \"string\" }", "Error processing /booleanRequired"}}, {
        // record with string field
        {"{\n" + "  \"type\" : \"record\",\n" + "  \"name\" : \"Foo\",\n" + "  \"fields\" : [\n"
            + "    { \"name\" : \"stringRequired\", \"type\" : ##T_START \"string\" ##T_END }\n" + "  ]\n" + "}\n"},
        {"{ \"stringRequired\" : \"bar\" }", "{\"stringRequired\":\"bar\"}"},
        {"{ }", "Error processing /stringRequired"},
        {"{ \"stringRequired\" : null }", "Error processing /stringRequired"},
        {"{ \"stringRequired\" : false }", "Error processing /stringRequired"}}, {
        // record with bytes field
        {"{\n" + "  \"type\" : \"record\",\n" + "  \"name\" : \"Foo\",\n" + "  \"fields\" : [\n"
            + "    { \"name\" : \"bytesRequired\", \"type\" : ##T_START \"bytes\" ##T_END }\n" + "  ]\n" + "}\n"},
        {"{ \"bytesRequired\" : \"12345\\u0001\" }", "{\"bytesRequired\":\"12345\\u0001\"}"},
        {"{ }", "Error processing /bytesRequired"}, {"{ \"bytesRequired\" : null }", "Error processing /bytesRequired"},
        {"{ \"bytesRequired\" : false }", "Error processing /bytesRequired"},
        {"{ \"bytesRequired\" : \"1234\\u0101\" }", "Error processing /bytesRequired"}}, {
        // record with fixed field
        {"{\n" + "  \"type\" : \"record\",\n" + "  \"name\" : \"Foo\",\n" + "  \"fields\" : [\n" + "    {\n"
            + "      \"name\" : \"fixedRequired\",\n"
            + "      \"type\" : ##T_START { \"type\" : \"fixed\", \"name\" : \"Fixed5\", \"size\" : 5 } ##T_END\n"
            + "    }\n" + "  ]\n" + "}\n"}, {"{ \"fixedRequired\" : \"12345\" }", "{\"fixedRequired\":\"12345\"}"},
        {"{ }", "Error processing /fixedRequired"}, {"{ \"fixedRequired\" : null }", "Error processing /fixedRequired"},
        {"{ \"fixedRequired\" : false }", "Error processing /fixedRequired"},
        {"{ \"fixedRequired\" : \"1234\" }", "Error processing /fixedRequired"},
        {"{ \"fixedRequired\" : \"123456\" }", "Error processing /fixedRequired"}}, {
        // record with enum field
        {"{\n" + "  \"type\" : \"record\",\n" + "  \"name\" : \"Foo\",\n" + "  \"fields\" : [\n" + "    {\n"
            + "      \"name\" : \"enumRequired\",\n" + "      \"type\" : ##T_START {\n"
            + "        \"name\" : \"Fruits\",\n" + "        \"type\" : \"enum\",\n"
            + "        \"symbols\" : [ \"APPLE\", \"ORANGE\" ]\n" + "      } ##T_END\n" + "    }\n" + "  ]\n" + "}\n"},
        {"{ \"enumRequired\" : \"APPLE\" }", "{\"enumRequired\":\"APPLE\"}"},
        {"{ \"enumRequired\" : \"ORANGE\" }", "{\"enumRequired\":\"ORANGE\"}"},
        {"{ }", "Error processing /enumRequired"}, {"{ \"enumRequired\" : null }", "Error processing /enumRequired"},
        {"{ \"enumRequired\" : false }", "Error processing /enumRequired"}}, {
        ...
        {"{ \"arrayRequired\" : [ \"APPLE\", \"ORANGE\" ] }", "{\"arrayRequired\":[\"APPLE\",\"ORANGE\"]}"},
        {"{ }", "Error processing /arrayRequired"}, {"{ \"arrayRequired\" : null }", "Error processing /arrayRequired"},
        {"{ \"arrayRequired\" : {} }", "Error processing /arrayRequired"},
        {"{ \"arrayRequired\" : [ null ] }", "Error processing /arrayRequired/0"},
        {"{ \"arrayRequired\" : [ \"APPLE\", \"PINEAPPLE\" ] }", "Error processing /arrayRequired/1"}}, {
        // record with map field
        {"{\n" + "  \"type\" : \"record\",\n" + "  \"name\" : \"Foo\",\n" + "  \"fields\" : [\n" + "    {\n"
            + "      \"name\" : \"mapRequired\",\n" + "      \"type\" : ##T_START {\n" + "        \"type\" : \"map\",\n"
            + "        \"values\" : \"int\" " + "      } ##T_END\n" + "    }\n" + "  ]\n" + "}\n"},
        {"{ \"mapRequired\" : {} }", "{\"mapRequired\":{}}"},
        {"{ \"mapRequired\" : { \"x\" : 1} }", "{\"mapRequired\":{\"x\":1}}"}, {"{ }", "Error processing /mapRequired"},
        {"{ \"mapRequired\" : null }", "Error processing /mapRequired"},
        {"{ \"mapRequired\" : [] }", "Error processing /mapRequired"},
        {"{ \"mapRequired\" : { \"x\" : null } }", "Error processing /mapRequired/x"},
        {"{ \"mapRequired\" : { \"x\" : \"PINEAPPLE\" } }", "Error processing /mapRequired/x"}}, {
        // record with union field
        {"{\n" + "  \"type\" : \"record\",\n" + "  \"name\" : \"foo.Foo\",\n" + "  \"fields\" : [\n" + "    {\n"
            + "      \"name\" : \"unionRequired\",\n"
            + "      \"type\" : ##T_START [ \"int\", \"string\", \"foo.Foo\" ] ##T_END\n" + "    }\n" + "  ]\n"
            + "}\n"}, {"{ \"unionRequired\" : { \"int\" : 5 } }", "{\"unionRequired\":{\"int\":5}}"},
        {"{ \"unionRequired\" : { \"string\" : \"s1\" }  }", "{\"unionRequired\":{\"string\":\"s1\"}}"},
        {"{ \"unionRequired\" : { \"foo.Foo\" : { \"unionRequired\" : { \"int\" : 5 } } } }",
            "{\"unionRequired\":{\"##NS(foo.)Foo\":{\"unionRequired\":{\"int\":5}}}}"},
        {"{ }", "Error processing /unionRequired"}, {"{ \"unionRequired\" : null }", "Error processing /unionRequired"},
        {"{ \"unionRequired\" : {} }", "Error processing /unionRequired"},
        {"{ \"unionRequired\" : { \"bad\" : 0 } }", "Error processing /unionRequired"}}, {
        ...
        {"{ \"uwaRequiredNoNull\" : null }", "Error processing /uwaRequiredNoNull"},
        {"{}", "Error processing /uwaRequiredNoNull"},
        {"{ \"uwaRequiredNoNull\" : {} }", "Error processing /uwaRequiredNoNull"},
        {"{ \"uwaRequiredNoNull\" : \"Union with aliases!\" }", "Error processing /uwaRequiredNoNull"},
        {"{ \"uwaRequiredNoNull\" : { \"string\" : \"Union with aliases!\" } }", "Error processing /uwaRequiredNoNull"},
        {"{ \"uwaRequiredNoNull\" : { \"success\" : 123 } }", "Error processing /uwaRequiredNoNull/success"}}, {
        ...
        {"{ \"uwaRequiredWithNull\" : {} }", "Error processing /uwaRequiredWithNull"},
        {"{ \"uwaRequiredWithNull\" : \"Union with aliases!\" }", "Error processing /uwaRequiredWithNull"},
        {"{ \"uwaRequiredWithNull\" : { \"string\" : \"Union with aliases!\" } }",
            "Error processing /uwaRequiredWithNull"},
        {"{ \"uwaRequiredWithNull\" : { \"success\" : 123 } }", "Error processing /uwaRequiredWithNull/success"}}, {
        ...
        {"{\n" + "  \"type\" : \"record\",\n" + "  \"name\" : \"foo.Foo\",\n" + "  \"fields\" : [\n" + "    {\n"
            ...
            + "    }\n" + "  ]\n" + "}\n"},
        {"{ \"arrayOfUnionWitNull\" : [ { \"int\" : 5 } ] }", "{\"arrayOfUnionWitNull\":[{\"int\":5}]}"},
        {"{ \"arrayOfUnionWitNull\" : [ null ] }", "{\"arrayOfUnionWitNull\":[null]}"},
        {"{ }", "Error processing /arrayOfUnionWitNull"},
        {"{ \"arrayOfUnionWitNull\" : [ {} ] }", "Error processing /arrayOfUnionWitNull/0"},
        {"{ \"arrayOfUnionWitNull\" : [ { \"bad\" : 0 } ] }", "Error processing /arrayOfUnionWitNull/0"}}, {
        ...
        {"{ \n" + "  \"type\" : \"record\",\n" + "  \"name\" : \"Foo\",\n" + "  \"fields\" : [\n" + "    {\n"
            ...
            + "      } ##T_END\n" + "    }\n" + "  ]\n" + "}\n"},
        {"{ \"bar\" : { \"baz\" : 1 } }", "{\"bar\":{\"baz\":1}}"},
        {"{ \"bar\" : { \"baz\" : null } }", "Error processing /bar/baz"},},
        //
        // Optional
        //
        {
            ...
            {"{\n" + "  \"type\" : \"record\",\n" + "  \"name\" : \"Foo\",\n" + "  \"fields\" : [\n" + "    {\n"
                ...
                + "      \"optional\" : true\n" + "    }\n" + "  ]\n" + "}\n"}, {"{ }", "{\"intOptional\":null}"},
            {"{ \"intOptional\" : 42 }", "{\"intOptional\":{\"int\":42}}"},
            {"{ \"intOptional\" : null }", ONE_WAY, "{\"intOptional\":null}"},
            {"{ \"intOptional\" : \"s1\" }", "Error processing /intOptional"},
            {"{ \"intOptional\" : {} }", "Error processing /intOptional"},}, {
        // record with optional union field that does not include null
        {"{\n" + "  \"type\" : \"record\",\n" + "  \"name\" : \"Foo\",\n" + "  \"fields\" : [\n" + "    {\n"
            + "      \"name\" : \"unionOptional\",\n" + "      \"type\" : ##T_START [ \"int\", \"string\" ] ##T_END,\n"
            + "      \"optional\" : true\n" + "    }\n" + "  ]\n" + "}\n"}, {"{ }", "{\"unionOptional\":null}"},
        {"{ \"unionOptional\" : { \"int\" : 42 } }", "{\"unionOptional\":{\"int\":42}}"},
        {"{ \"unionOptional\" : { \"string\" : \"s1\" } }", "{\"unionOptional\":{\"string\":\"s1\"}}"},
        {"{ \"unionOptional\" : null }", ONE_WAY, "{\"unionOptional\":null}"},
        {"{ \"unionOptional\" : \"s1\" }", "Error processing /unionOptional"},
        {"{ \"unionOptional\" : {} }", "Error processing /unionOptional"},}, {
        ...
        {"{ \"unionOptional\" : null }",
            ...
            ONE_WAY, "{\"unionOptional\":null}"}, {"{ \"unionOptional\" : \"s1\" }", "Error processing /unionOptional"},
        {"{ \"unionOptional\" : {} }", "Error processing /unionOptional"},}, {
        ...
        {"{ \"uwaOptionalNoNull\" : null }", ONE_WAY, "{\"uwaOptionalNoNull\":null}"},
        {"{ \"uwaOptionalNoNull\" : {} }", "Error processing /uwaOptionalNoNull"},
        {"{ \"uwaOptionalNoNull\" : \"Union with aliases!\" }", "Error processing /uwaOptionalNoNull"},
        {"{ \"uwaOptionalNoNull\" : { \"string\" : \"Union with aliases!\" } }", "Error processing /uwaOptionalNoNull"},
        {"{ \"uwaOptionalNoNull\" : { \"success\" : 123 } }", "Error processing /uwaOptionalNoNull/success"}}, {
        ...
        {"{ \"uwaOptionalWithNull\" : null }", "{\"uwaOptionalWithNull\":null}"},
        {"{ \"uwaOptionalWithNull\" : {} }", "Error processing /uwaOptionalWithNull"},
        {"{ \"uwaOptionalWithNull\" : \"Union with aliases!\" }", "Error processing /uwaOptionalWithNull"},
        {"{ \"uwaOptionalWithNull\" : { \"string\" : \"Union with aliases!\" } }",
            "Error processing /uwaOptionalWithNull"},
        {"{ \"uwaOptionalWithNull\" : { \"success\" : 123 } }", "Error processing /uwaOptionalWithNull/success"}}, {
        // record with optional enum field
        {"{\n" + "  \"type\" : \"record\",\n" + "  \"name\" : \"Foo\",\n" + "  \"fields\" : [\n" + "    {\n"
            + "      \"name\" : \"enumOptional\",\n"
            + "      \"type\" : ##T_START { \"type\" : \"enum\", \"name\" : \"foo.bar\", \"symbols\" : [ \"A\", \"B\" ] } ##T_END,\n"
            + "      \"optional\" : true\n" + "    }\n" + "  ]\n" + "}\n"}, {"{ }", "{\"enumOptional\":null}"},
        {"{ \"enumOptional\" : \"A\" } }", "{\"enumOptional\":{\"##NS(foo.)bar\":\"A\"}}"},
        {"{ \"enumOptional\" : \"B\" } }", "{\"enumOptional\":{\"##NS(foo.)bar\":\"B\"}}"},
        {"{ \"enumOptional\" : {} }", "Error processing /enumOptional"},}, {
        // record with optional enum field
        {"{\n" + "  \"type\" : \"record\",\n" + "  \"name\" : \"Foo\",\n" + "  \"fields\" : [\n" + "    {\n"
            + "      \"name\" : \"enumOptional\",\n"
            + "      \"type\" : ##T_START { \"type\" : \"enum\", \"name\" : \"foo.bar\", \"symbols\" : [ \"A\", \"B\" ] } ##T_END,\n"
        ...
        {"{ \"unionOptional\" : { \"R1\" : { \"r1\" : \"value\" } } }",
            "{\"unionOptional\":{\"R1\":{\"r1\":\"value\"}}}"},
        {"{ \"unionOptional\" : { \"R2\" : { \"r2\" : 52 } } }", "{\"unionOptional\":{\"R2\":{\"r2\":52}}}"},
        {"{ \"unionOptional\" : { \"int\" : 52 } }", "{\"unionOptional\":{\"int\":52}}"},
        {"{ \"unionOptional\" : { \"string\" : \"value\" } }", "{\"unionOptional\":{\"string\":\"value\"}}"},
        {"{ \"unionOptional\" : {} }", "Error processing /unionOptional"},}, {
        ...
        {"{ \"unionOptionalAlias\" : {} }", "Error processing /unionOptionalAlias"},
  ...
  public void testInfinityAndNan() throws IOException {
    ...
    Object[][] inputs =
        {{"{ \"doubleRequired\" : \"Infinity\", \"floatRequired\" : \"Infinity\"}", Double.POSITIVE_INFINITY,
            Float.POSITIVE_INFINITY},
            {"{ \"doubleRequired\" : \"NaN\", \"floatRequired\" : \"NaN\"}", Double.NaN, Float.NaN},
            {"{ \"doubleRequired\" : \"-Infinity\", \"floatRequired\" : \"-Infinity\"}", Double.NEGATIVE_INFINITY,
  ...
  private void testDataTranslation(String schemaText, String[][] row) throws IOException {
    ...
    for (int col = 1; col < row.length; col++) {
      ...
      if (avroRecord != null) {
        ...
        ValidationResult vr = ValidateDataAgainstSchema.validate(dataMapResult, recordDataSchema,
        ...
        DataMap dataMapFromBinaryResult =
            DataTranslator.genericRecordToDataMap(avroRecordFromBytes, recordDataSchema, avroSchema);
        vr = ValidateDataAgainstSchema.validate(dataMapFromBinaryResult, recordDataSchema,
            new ValidationOptions(RequiredMode.MUST_BE_PRESENT, CoercionMode.NORMAL));
  ...
  public Object[][] defaultToAvroOptionalTranslationProvider() {
    ...
    return new Object[][]{
        // 1. If the dataMap has customer set values, the mode should have no impact on the DataTranslator. Tests for Int
        {
            ...
            "{\"bar\":1}", PegasusToAvroDefaultFieldTranslationMode.TRANSLATE, "{\"bar\":1}", false, "",}, {
        // required int with default value
        "{ \"type\" : \"record\", \"name\" : \"foo\", \"fields\" : [ { \"name\" : \"bar\", \"type\" : ##T_START \"int\" ##T_END, \"default\" : 42 } ] }",
        PegasusToAvroDefaultFieldTranslationMode.TRANSLATE,
        "{\"type\":\"record\",\"name\":\"foo\",\"fields\":[{\"name\":\"bar\",\"type\":\"int\",\"default\":42}]}",
        "{\"bar\":1}", PegasusToAvroDefaultFieldTranslationMode.DO_NOT_TRANSLATE, "{\"bar\":1}", false, "",},

        {
            ...
            "{\"bar\":1}", PegasusToAvroDefaultFieldTranslationMode.TRANSLATE, "{\"bar\":{\"int\":1}}",
            // Json representation for Avro record
            false, "",},

        {
            ...
            PegasusToAvroDefaultFieldTranslationMode.DO_NOT_TRANSLATE,
            "{\"type\":\"record\",\"name\":\"foo\",\"fields\":[{\"name\":\"bar\",\"type\":[\"null\",\"int\"],\"default\":null}]}",
            "{\"bar\":1}", PegasusToAvroDefaultFieldTranslationMode.DO_NOT_TRANSLATE, "{\"bar\":{\"int\":1}}",
            // Json representation for Avro record
            false, "",},
        ...
        {"{ \"type\" : \"record\", \"name\" : \"Foo\", \"fields\" : [ { \"name\" : \"arrayRequired\", \"type\" : ##T_START { \"type\" : \"array\", \"items\" : \"string\" } ##T_END, \"default\": [ ] } ] }",
            ...
            "{\"arrayRequired\":[\"a\",\"b\"]}", PegasusToAvroDefaultFieldTranslationMode.TRANSLATE,
            "{\"arrayRequired\":[\"a\",\"b\"]}", false, "",},
        {"{ \"type\" : \"record\", \"name\" : \"Foo\", \"fields\" : [ { \"name\" : \"arrayRequired\", \"type\" : ##T_START { \"type\" : \"array\", \"items\" : \"string\" } ##T_END, \"default\": [ ] } ] }",
            PegasusToAvroDefaultFieldTranslationMode.TRANSLATE,
            "{\"type\":\"record\",\"name\":\"Foo\",\"fields\":[{\"name\":\"arrayRequired\",\"type\":{\"type\":\"array\",\"items\":\"string\"},\"default\":[]}]}",
            "{\"arrayRequired\":[\"a\",\"b\"]}", PegasusToAvroDefaultFieldTranslationMode.DO_NOT_TRANSLATE,
            "{\"arrayRequired\":[\"a\",\"b\"]}", false, "",},
        {"{ \"type\" : \"record\", \"name\" : \"Foo\", \"fields\" : [ { \"name\" : \"arrayRequired\", \"type\" : ##T_START { \"type\" : \"array\", \"items\" : \"string\" } ##T_END, \"default\": [ ] } ] }",
            PegasusToAvroDefaultFieldTranslationMode.DO_NOT_TRANSLATE,
        ...
        {"{ \"type\" : \"record\", \"name\" : \"foo\", \"fields\" : [ { \"name\" : \"bar\", \"type\" : ##T_START [\"int\", \"string\"] ##T_END, \"default\" : { \"int\" : 42 } } ] }",
            ...
            "{\"bar\":{\"int\":42}}", PegasusToAvroDefaultFieldTranslationMode.TRANSLATE, "{\"bar\":{\"int\":42}}",
            false, "",},
        {"{ \"type\" : \"record\", \"name\" : \"foo\", \"fields\" : [ { \"name\" : \"bar\", \"type\" : ##T_START [\"int\", \"string\"] ##T_END, \"default\" : { \"int\" : 42 } } ] }",
            PegasusToAvroDefaultFieldTranslationMode.TRANSLATE,
            "{\"type\":\"record\",\"name\":\"foo\",\"fields\":[{\"name\":\"bar\",\"type\":[\"int\",\"string\"],\"default\":42}]}",
            "{\"bar\":{\"int\":42}}", PegasusToAvroDefaultFieldTranslationMode.DO_NOT_TRANSLATE,
            "{\"bar\":{\"int\":42}}", false, "",},
        {"{ \"type\" : \"record\", \"name\" : \"foo\", \"fields\" : [ { \"name\" : \"bar\", \"type\" : ##T_START [\"int\", \"string\"] ##T_END, \"default\" : { \"int\" : 42 } } ] }",
            PegasusToAvroDefaultFieldTranslationMode.DO_NOT_TRANSLATE,
        ...
        {"{ \"type\" : \"record\", \"name\" : \"Foo\", \"fields\" : [ { \"name\" : \"mapRequired\", \"type\" : ##T_START { \"type\" : \"map\", \"values\" : \"string\" } ##T_END, \"default\": {} } ] }",
            ...
            "{\"mapRequired\":{\"somekey\":\"somevalue\"}}", PegasusToAvroDefaultFieldTranslationMode.TRANSLATE,
            "{\"mapRequired\":{\"somekey\":\"somevalue\"}}", false, "",},
        {"{ \"type\" : \"record\", \"name\" : \"Foo\", \"fields\" : [ { \"name\" : \"mapRequired\", \"type\" : ##T_START { \"type\" : \"map\", \"values\" : \"string\" } ##T_END, \"default\": {} } ] }",
            PegasusToAvroDefaultFieldTranslationMode.TRANSLATE,
            "{\"type\":\"record\",\"name\":\"Foo\",\"fields\":[{\"name\":\"mapRequired\",\"type\":{\"type\":\"map\",\"values\":\"string\"},\"default\":{}}]}",
            "{\"mapRequired\":{\"somekey\":\"somevalue\"}}", PegasusToAvroDefaultFieldTranslationMode.DO_NOT_TRANSLATE,
            "{\"mapRequired\":{\"somekey\":\"somevalue\"}}", false, "",},
        {"{ \"type\" : \"record\", \"name\" : \"Foo\", \"fields\" : [ { \"name\" : \"mapRequired\", \"type\" : ##T_START { \"type\" : \"map\", \"values\" : \"string\" } ##T_END, \"default\": {} } ] }",
            PegasusToAvroDefaultFieldTranslationMode.DO_NOT_TRANSLATE,
            "{\"type\":\"record\",\"name\":\"Foo\",\"fields\":[{\"name\":\"mapRequired\",\"type\":[\"null\",{\"type\":\"map\",\"values\":\"string\"}],\"default\":null}]}",
            "{\"mapRequired\":{\"somekey\":\"somevalue\"}}", PegasusToAvroDefaultFieldTranslationMode.TRANSLATE,
            "{\"mapRequired\":{\"map\":{\"somekey\":\"somevalue\"}}}", false, "",},
        {"{ \"type\" : \"record\", \"name\" : \"Foo\", \"fields\" : [ { \"name\" : \"mapRequired\", \"type\" : ##T_START { \"type\" : \"map\", \"values\" : \"string\" } ##T_END, \"default\": {} } ] }",
            PegasusToAvroDefaultFieldTranslationMode.DO_NOT_TRANSLATE,
            "{\"type\":\"record\",\"name\":\"Foo\",\"fields\":[{\"name\":\"mapRequired\",\"type\":[\"null\",{\"type\":\"map\",\"values\":\"string\"}],\"default\":null}]}",
            "{\"mapRequired\":{\"somekey\":\"somevalue\"}}", PegasusToAvroDefaultFieldTranslationMode.DO_NOT_TRANSLATE,
        ...
        {" { " + "   \"type\" : \"record\", " + "   \"name\" : \"Foo\", " + "   \"fields\" : [ { "
            + "     \"name\" : \"nestedField\", " + "     \"type\" : { " + "       \"type\" : \"record\", "
            + "       \"name\" : \"nestedRecord\", " + "       \"fields\" : [ { " + "         \"name\" : \"field1\", "
            + "         \"type\" : \"int\" " + "       } ] " + "     }, " + "     \"default\": { \"field1\" : 1} "
            + "   } ] " + " } ", PegasusToAvroDefaultFieldTranslationMode.TRANSLATE,
            ...
            PegasusToAvroDefaultFieldTranslationMode.TRANSLATE, "{\"nestedField\":{\"field1\":42}}", false, "",},
        {" { " + "   \"type\" : \"record\", " + "   \"name\" : \"Foo\", " + "   \"fields\" : [ { "
            + "     \"name\" : \"nestedField\", " + "     \"type\" : { " + "       \"type\" : \"record\", "
            + "       \"name\" : \"nestedRecord\", " + "       \"fields\" : [ { " + "         \"name\" : \"field1\", "
            + "         \"type\" : \"int\" " + "       } ] " + "     }, " + "     \"default\": { \"field1\" : 1} "
            ...
            "{\"type\":\"record\",\"name\":\"Foo\",\"fields\":[{\"name\":\"nestedField\",\"type\":{\"type\":\"record\",\"name\":\"nestedRecord\",\"fields\":[{\"name\":\"field1\",\"type\":\"int\"}]},\"default\":{\"field1\":1}}]}",
            " { " + "     \"nestedField\": { " + "         \"field1\":42 " + "     } " + " } ",
            PegasusToAvroDefaultFieldTranslationMode.DO_NOT_TRANSLATE, "{\"nestedField\":{\"field1\":42}}", false, "",},
        {" { " + "   \"type\" : \"record\", " + "   \"name\" : \"Foo\", " + "   \"fields\" : [ { "
            + "     \"name\" : \"nestedField\", " + "     \"type\" : { " + "       \"type\" : \"record\", "
            + "       \"name\" : \"nestedRecord\", " + "       \"fields\" : [ { " + "         \"name\" : \"field1\", "
            + "         \"type\" : \"int\" " + "       } ] " + "     }, " + "     \"default\": { \"field1\" : 1} "
            ...
            " { " + "     \"nestedField\": { " + "         \"field1\":42 " + "     } " + " } ",
            PegasusToAvroDefaultFieldTranslationMode.TRANSLATE, "{\"nestedField\":{\"nestedRecord\":{\"field1\":42}}}",
            false, "",}, {" { " + "   \"type\" : \"record\", " + "   \"name\" : \"Foo\", " + "   \"fields\" : [ { "
        + "     \"name\" : \"nestedField\", " + "     \"type\" : { " + "       \"type\" : \"record\", "
        + "       \"name\" : \"nestedRecord\", " + "       \"fields\" : [ { " + "         \"name\" : \"field1\", "
        + "         \"type\" : \"int\" " + "       } ] " + "     }, " + "     \"default\": { \"field1\" : 1} "
        + "   } ] " + " } ", PegasusToAvroDefaultFieldTranslationMode.DO_NOT_TRANSLATE,
        ...
        " { " + "     \"nestedField\": { " + "         \"field1\":42 " + "     } " + " } ",
        PegasusToAvroDefaultFieldTranslationMode.DO_NOT_TRANSLATE,
        "{\"nestedField\":{\"nestedRecord\":{\"field1\":42}}}", false, "",},
        ...
        // 6. Test when input is missing, using int
        {
            ...
            PegasusToAvroDefaultFieldTranslationMode.TRANSLATE,
            "{\"type\":\"record\",\"name\":\"foo\",\"fields\":[{\"name\":\"bar\",\"type\":\"int\",\"default\":42}]}",
            "{}", PegasusToAvroDefaultFieldTranslationMode.TRANSLATE, "{\"bar\":42}", false, "",}, {
        // required int with default value
        "{ \"type\" : \"record\", \"name\" : \"foo\", \"fields\" : [ { \"name\" : \"bar\", \"type\" : ##T_START \"int\" ##T_END, \"default\" : 42 } ] }",
        PegasusToAvroDefaultFieldTranslationMode.DO_NOT_TRANSLATE, // this option translate to optional in Avro
        "{\"type\":\"record\",\"name\":\"foo\",\"fields\":[{\"name\":\"bar\",\"type\":[\"null\",\"int\"],\"default\":null}]}",
        "{}", PegasusToAvroDefaultFieldTranslationMode.TRANSLATE, "{\"bar\":{\"int\":42}}", false, "",},

        {
            ...
            PegasusToAvroDefaultFieldTranslationMode.DO_NOT_TRANSLATE, // this option translate to optional in Avro
            "{\"type\":\"record\",\"name\":\"foo\",\"fields\":[{\"name\":\"bar\",\"type\":[\"null\",\"int\"],\"default\":null}]}",
            "{}", PegasusToAvroDefaultFieldTranslationMode.DO_NOT_TRANSLATE, "{\"bar\":null}", false, "",},
        ...
        // 7. Test when input is missing, using union
        {
            ...
            PegasusToAvroDefaultFieldTranslationMode.TRANSLATE,
            "{\"type\":\"record\",\"name\":\"foo\",\"fields\":[{\"name\":\"bar\",\"type\":[\"int\",\"string\"],\"default\":42}]}",
            "{}", PegasusToAvroDefaultFieldTranslationMode.TRANSLATE, "{\"bar\":{\"int\":42}}",
            //  DataTranslator should translate to the default value in the schema
            false, "",}, {
        // required Union of [int string] with default value
        "{ \"type\" : \"record\", \"name\" : \"foo\", \"fields\" : [ { \"name\" : \"bar\", \"type\" : ##T_START [\"int\", \"string\"] ##T_END, \"default\" : { \"int\" : 42 } } ] }",
        PegasusToAvroDefaultFieldTranslationMode.DO_NOT_TRANSLATE,
...

        {
            ...
            PegasusToAvroDefaultFieldTranslationMode.DO_NOT_TRANSLATE,
            "{\"type\":\"record\",\"name\":\"foo\",\"fields\":[{\"name\":\"bar\",\"type\":[\"null\",\"int\",\"string\"],\"default\":null}]}",
            "{}", PegasusToAvroDefaultFieldTranslationMode.DO_NOT_TRANSLATE, "{\"bar\":null}",
            //read as optional from Avro
            false, "",},
        ...
        {"{ \"type\" : \"record\", \"name\" : \"Foo\", \"fields\" : [ { \"name\" : \"arrayRequired\", \"type\" : ##T_START { \"type\" : \"array\", \"items\" : \"string\" } ##T_END, \"default\": [ ] } ] }",
            PegasusToAvroDefaultFieldTranslationMode.TRANSLATE,
            "{\"type\":\"record\",\"name\":\"Foo\",\"fields\":[{\"name\":\"arrayRequired\",\"type\":{\"type\":\"array\",\"items\":\"string\"},\"default\":[]}]}",
            "{}", PegasusToAvroDefaultFieldTranslationMode.TRANSLATE, "{\"arrayRequired\":[]}", false, "",},
        {"{ \"type\" : \"record\", \"name\" : \"Foo\", \"fields\" : [ { \"name\" : \"arrayRequired\", \"type\" : ##T_START { \"type\" : \"array\", \"items\" : \"string\" } ##T_END, \"default\": [ ] } ] }",
            PegasusToAvroDefaultFieldTranslationMode.DO_NOT_TRANSLATE,
            "{\"type\":\"record\",\"name\":\"Foo\",\"fields\":[{\"name\":\"arrayRequired\",\"type\":[\"null\",{\"type\":\"array\",\"items\":\"string\"}],\"default\":null}]}",
            "{}", PegasusToAvroDefaultFieldTranslationMode.TRANSLATE, "{\"arrayRequired\":{\"array\":[]}}", false, "",},
        {"{ \"type\" : \"record\", \"name\" : \"Foo\", \"fields\" : [ { \"name\" : \"arrayRequired\", \"type\" : ##T_START { \"type\" : \"array\", \"items\" : \"string\" } ##T_END, \"default\": [ ] } ] }",
            PegasusToAvroDefaultFieldTranslationMode.DO_NOT_TRANSLATE,
            "{\"type\":\"record\",\"name\":\"Foo\",\"fields\":[{\"name\":\"arrayRequired\",\"type\":[\"null\",{\"type\":\"array\",\"items\":\"string\"}],\"default\":null}]}",
            "{}", PegasusToAvroDefaultFieldTranslationMode.DO_NOT_TRANSLATE, "{\"arrayRequired\":null}", false, "",},

        // 9. Test when input is missing, using map
        {"{ \"type\" : \"record\", \"name\" : \"Foo\", \"fields\" : [ { \"name\" : \"mapRequired\", \"type\" : ##T_START { \"type\" : \"map\", \"values\" : \"string\" } ##T_END, \"default\": {} } ] }",
            PegasusToAvroDefaultFieldTranslationMode.TRANSLATE,
            "{\"type\":\"record\",\"name\":\"Foo\",\"fields\":[{\"name\":\"mapRequired\",\"type\":{\"type\":\"map\",\"values\":\"string\"},\"default\":{}}]}",
            "{}", PegasusToAvroDefaultFieldTranslationMode.TRANSLATE, "{\"mapRequired\":{}}", false, "",},
        {"{ \"type\" : \"record\", \"name\" : \"Foo\", \"fields\" : [ { \"name\" : \"mapRequired\", \"type\" : ##T_START { \"type\" : \"map\", \"values\" : \"string\" } ##T_END, \"default\": {} } ] }",
            PegasusToAvroDefaultFieldTranslationMode.DO_NOT_TRANSLATE,
            "{\"type\":\"record\",\"name\":\"Foo\",\"fields\":[{\"name\":\"mapRequired\",\"type\":[\"null\",{\"type\":\"map\",\"values\":\"string\"}],\"default\":null}]}",
            "{}", PegasusToAvroDefaultFieldTranslationMode.TRANSLATE, "{\"mapRequired\":{\"map\":{}}}", false, "",},
        {"{ \"type\" : \"record\", \"name\" : \"Foo\", \"fields\" : [ { \"name\" : \"mapRequired\", \"type\" : ##T_START { \"type\" : \"map\", \"values\" : \"string\" } ##T_END, \"default\": {} } ] }",
            PegasusToAvroDefaultFieldTranslationMode.DO_NOT_TRANSLATE,
            "{\"type\":\"record\",\"name\":\"Foo\",\"fields\":[{\"name\":\"mapRequired\",\"type\":[\"null\",{\"type\":\"map\",\"values\":\"string\"}],\"default\":null}]}",
            "{}", PegasusToAvroDefaultFieldTranslationMode.DO_NOT_TRANSLATE, "{\"mapRequired\":null}", false, "",},
        ...
        {" { " + "   \"type\" : \"record\", " + "   \"name\" : \"Foo\", " + "   \"fields\" : [ { "
            ...
            + "   } ] " + " } ", PegasusToAvroDefaultFieldTranslationMode.TRANSLATE,
            "{\"type\":\"record\",\"name\":\"Foo\",\"fields\":[{\"name\":\"nestedField\",\"type\":{\"type\":\"record\",\"name\":\"nestedRecord\",\"fields\":[{\"name\":\"field1\",\"type\":\"int\"}]},\"default\":{\"field1\":1}}]}",
            "{}", PegasusToAvroDefaultFieldTranslationMode.TRANSLATE, "{\"nestedField\":{\"field1\":1}}", false, "",},
        {" { " + "   \"type\" : \"record\", " + "   \"name\" : \"Foo\", " + "   \"fields\" : [ { "
            + "     \"name\" : \"nestedField\", " + "     \"type\" : { " + "       \"type\" : \"record\", "
            + "       \"name\" : \"nestedRecord\", " + "       \"fields\" : [ { " + "         \"name\" : \"field1\", "
            + "         \"type\" : \"int\" " + "       } ] " + "     }, " + "     \"default\": { \"field1\" : 1} "
            ...
            "{\"type\":\"record\",\"name\":\"Foo\",\"fields\":[{\"name\":\"nestedField\",\"type\":[\"null\",{\"type\":\"record\",\"name\":\"nestedRecord\",\"fields\":[{\"name\":\"field1\",\"type\":\"int\"}]}],\"default\":null}]}",
            "{}", PegasusToAvroDefaultFieldTranslationMode.TRANSLATE,
            "{\"nestedField\":{\"nestedRecord\":{\"field1\":1}}}", false, "",},
        {" { " + "   \"type\" : \"record\", " + "   \"name\" : \"Foo\", " + "   \"fields\" : [ { "
            + "     \"name\" : \"nestedField\", " + "     \"type\" : { " + "       \"type\" : \"record\", "
            + "       \"name\" : \"nestedRecord\", " + "       \"fields\" : [ { " + "         \"name\" : \"field1\", "
            + "         \"type\" : \"int\" " + "       } ] " + "     }, " + "     \"default\": { \"field1\" : 1} "
            + "   } ] " + " } ", PegasusToAvroDefaultFieldTranslationMode.DO_NOT_TRANSLATE,
            "{\"type\":\"record\",\"name\":\"Foo\",\"fields\":[{\"name\":\"nestedField\",\"type\":[\"null\",{\"type\":\"record\",\"name\":\"nestedRecord\",\"fields\":[{\"name\":\"field1\",\"type\":\"int\"}]}],\"default\":null}]}",
            "{}", PegasusToAvroDefaultFieldTranslationMode.DO_NOT_TRANSLATE, "{\"nestedField\":null}", false, "",},
        ...
        // 11. Test when input is missing, using enum
        {
            ...
            "{}", PegasusToAvroDefaultFieldTranslationMode.TRANSLATE, "{\"enumRequired\":\"APPLE\"}",
            //read as optional from Avro
            false, "",},
...
//        },

        {
            ...
            PegasusToAvroDefaultFieldTranslationMode.DO_NOT_TRANSLATE,
            "{\"type\":\"record\",\"name\":\"Foo\",\"fields\":[{\"name\":\"enumRequired\",\"type\":[\"null\",{\"type\":\"enum\",\"name\":\"Fruits\",\"symbols\":[\"APPLE\",\"ORANGE\"]}],\"default\":null}]}",
            "{}", PegasusToAvroDefaultFieldTranslationMode.DO_NOT_TRANSLATE, "{\"enumRequired\":null}",
            //read as optional from Avro
            false, "",},
        ...
        {
            // required int with default value
            "{ \"type\" : \"record\", \"name\" : \"foo\", \"fields\" : [ " + "{ \"name\" : \"bar\", \"type\" : "
                + "{ \"type\": \"record\", \"name\": \"Bar\", \"fields\": ["
                + " { \"name\": \"barInt\", \"type\": ##T_START \"int\" ##T_END, \"default\" : 42 }" + " ] },"
                + " \"default\": {}" + " } ] }", PegasusToAvroDefaultFieldTranslationMode.TRANSLATE,
            "{ \"type\" : \"record\", \"name\" : \"foo\", \"fields\" : [ " + "{ \"name\" : \"bar\", \"type\" : "
                + "{ \"type\": \"record\", \"name\": \"Bar\", \"fields\": ["
                + " { \"name\": \"barInt\", \"type\": \"int\", \"default\" : 42 }" + " ] },"
                + " \"default\": { \"barInt\":42 }" + " } ] }", "{\"bar\":{\"barInt\":42}}",
            PegasusToAvroDefaultFieldTranslationMode.TRANSLATE, "{\"bar\":{\"barInt\":42}}", false, "",},
        ...
        // If the field in pegasus schema has been translated as required, its data cannot be translated as optional
        {
            ...
            PegasusToAvroDefaultFieldTranslationMode.TRANSLATE,
            "{\"type\":\"record\",\"name\":\"foo\",\"fields\":[{\"name\":\"bar\",\"type\":\"int\",\"default\":42}]}",
            "{}", PegasusToAvroDefaultFieldTranslationMode.DO_NOT_TRANSLATE, "{\"bar\":null}", true,
            "null of int in field bar of foo",}, {
        // required Union of [int string] with default value
        "{ \"type\" : \"record\", \"name\" : \"foo\", \"fields\" : [ { \"name\" : \"bar\", \"type\" : ##T_START [\"int\", \"string\"] ##T_END, \"default\" : { \"int\" : 42 } } ] }",
        PegasusToAvroDefaultFieldTranslationMode.TRANSLATE,
        "{\"type\":\"record\",\"name\":\"foo\",\"fields\":[{\"name\":\"bar\",\"type\":[\"int\",\"string\"],\"default\":42}]}",
        "{}", PegasusToAvroDefaultFieldTranslationMode.DO_NOT_TRANSLATE, "{\"bar\":null}", //read as optional from Avro
    ...
    try {
      ...
      for (String pegasusSchemaText : schemaTextForTesting) {
        ...
        GenericRecord avroRecord =
            DataTranslator.dataMapToGenericRecord(dataMap, recordDataSchema, avroSchema, options);
  ...
  public void testAvroSchemaMissingFields() throws IOException {
    ...
    DataMap map = DataTranslator.genericRecordToDataMap(new GenericData.Record(avroSchema),
        (RecordDataSchema) TestUtil.dataSchemaFromString(P_SCHEMA), avroSchema);
    assertEquals(map.size(), 0);
  }

  @Test
  public void testMissingDefaultFieldsOnDataMap() throws IOException {
    final String SCHEMA = "{" + "   \"type\":\"record\"," + "   \"name\":\"Foo\"," + "   \"fields\":[" + "      {"
        + "         \"name\":\"field1\"," + "         \"type\":\"string\"" + "      }," + "      {"
        + "         \"name\":\"field2\"," + "         \"type\":{" + "            \"type\":\"array\","
    ...
    assertEquals(record.get("field2"),
        new GenericData.Array<>(0, Schema.createArray(Schema.create(Schema.Type.STRING))));
  }
  ...
  private static <T> T safeCast(Object toCast, Class<T> clazz) {
    ...
    return Optional.of(toCast)
        ...
        .orElseThrow(() -> new ClassCastException(
            String.format("Cast failed to class: %s for object: %s", clazz.getCanonicalName(), toCast)));
  }
  ...
  public Object[][] arrayFieldProvider() {
    return new Object[][]{{null}, {Collections.emptyList()},
        ...
        {getList(() -> new LinkedList<>(Arrays.asList("foo", "bar")))}, {getList(() -> {
  ...
  public void testArrayDataTranslation(List<String> arrayFieldValue) throws IOException {
    ...
    final String SCHEMA = "{" + "   \"type\":\"record\"," + "   \"name\":\"Foo\"," + "   \"fields\":[" + "      {"
        + "         \"name\":\"arrayField\"," + "         \"type\":{" + "            \"type\":\"array\","
        + "            \"items\":\"string\"" + "         }," + "         \"default\":[ ]" + "      }" + "   ]" + "}";
  ...
  public void testNamespaceOverrideWithOptionalField() throws IOException {
    ...
    GenericRecord avroRecord = AvroUtil.genericRecordFromJson(
        TestAvroUtil.namespaceProcessor("{ \"a\" : { \"##NS(avro.a.b.c.)FooFoo\": { \"b\" : 1 } } }"), avroSchema);

    // Test Avro-to-Pegasus
    AvroRecordToDataMapTranslationOptions avroRecordToDataMapTranslationOptions =
        new AvroRecordToDataMapTranslationOptions();
    avroRecordToDataMapTranslationOptions.setAvroToDataSchemaNamespaceMapping(
        Collections.singletonMap("avro.a.b.c", "a.b.c"));
    DataMap pegasusDataMap = DataTranslator.genericRecordToDataMap(avroRecord, recordDataSchema, avroSchema,
        avroRecordToDataMapTranslationOptions);
    ...
    dataMapToAvroRecordTranslationOptions.setAvroToDataSchemaNamespaceMapping(
        Collections.singletonMap("avro.a.b.c", "a.b.c"));
    GenericRecord reconvertedAvroRecord =
        DataTranslator.dataMapToGenericRecord(pegasusDataMap, recordDataSchema, avroSchema,
  ...
  public void testDataMapToSpecificRecordTranslatorInnerRecord() throws IOException {
    ...
    TestEventRecordOfRecord testEventRecordOfRecord = DataTranslator.dataMapToSpecificRecord(
        new DataMap(ImmutableMap.of("innerField", innerMap2, "stringArray", new DataList(Arrays.asList("val1")))),
        recordDataSchema, avroSchema);
  ...
  public void testArrayOfRecords() throws IOException {
    ...
    StringRecord stringRecordEvent = DataTranslator.dataMapToSpecificRecord(stringRecord,
        (RecordDataSchema) TestUtil.dataSchemaFromString(StringRecord.TEST_SCHEMA.toString()),
        StringRecord.TEST_SCHEMA);
  ...
  public void testMapArrayUnion() throws IOException {
    ...
    DataMap arrayData = new DataMap(
        ImmutableMap.of("mapOrArray", new DataMap(ImmutableMap.of("array", new DataList(Arrays.asList("a"))))));
    MapArrayUnion arrayUnion =
        DataTranslator.dataMapToSpecificRecord(arrayData, recordDataSchemaMapArrayUnion, MapArrayUnion.TEST_SCHEMA);

    DataMap mapData = new DataMap(ImmutableMap.of("mapOrArray",
        new DataMap(ImmutableMap.of("map", new DataMap(ImmutableMap.of("key", "value"))))));
    MapArrayUnion mapUnion =
        DataTranslator.dataMapToSpecificRecord(mapData, recordDataSchemaMapArrayUnion, MapArrayUnion.TEST_SCHEMA);

    DataMap arrayOfMapArrayUnionData =
        new DataMap(ImmutableMap.of("recordArray", new DataList(Arrays.asList(arrayData, mapData))));
    ArrayOfMapArrayUnion arrayOfMapArrayUnion =
        DataTranslator.dataMapToSpecificRecord(arrayOfMapArrayUnionData, recordDataSchema,
            ArrayOfMapArrayUnion.TEST_SCHEMA);
    ...
    MapOfArrayOfMapArrayUnion mapOfArrayOfMapArrayUnion =
        DataTranslator.dataMapToSpecificRecord(mapOfArrayOfMapArrayUnionData, recordDataSchemaOfMap,
            MapOfArrayOfMapArrayUnion.TEST_SCHEMA);

    DataMap mapOfMapOfArrayOfMapArrayUnionData = new DataMap(
        ImmutableMap.of("recordMap", new DataMap(ImmutableMap.of("recordMap", mapOfArrayOfMapArrayUnionData))));
    MapOfMapOfArrayOfMapArrayUnion mapOfMapOfArrayOfMapArrayUnion =
        DataTranslator.dataMapToSpecificRecord(mapOfMapOfArrayOfMapArrayUnionData, recordDataSchemaOfMapOfMap,
    ...
    Assert.assertEquals(((Map<?, ?>) mapOfArrayOfMapArrayUnion.get(0)).get("recordArray"),
        Arrays.asList(arrayUnion, mapUnion));

    Assert.assertTrue(mapOfMapOfArrayOfMapArrayUnion.get(0) instanceof Map);
    Assert.assertEquals(((Map<?, ?>) mapOfMapOfArrayOfMapArrayUnion.get(0)).get("recordMap"),
        mapOfArrayOfMapArrayUnion);
  }
  ...
  public void testUnionWithoutFieldDescriptor() throws IOException {
    ...
    String protoToPdlToAvroSchema =
        "{\"type\":\"record\"," + "\"name\":\"Foo\"," + "\"fields\":[{\"name\":\"oneofField\"," + "\"type\":[\"null\",{"
            + "\"type\":\"record\"," + "\"name\":\"FooOneofField\"," + "\"fields\":[{" + "\"name\":\"oneofIntField\","
            + "\"type\":[\"null\",\"int\"]," + "\"default\":null},{" + "\"name\":\"oneofStringField\","
            + "\"type\":[\"null\",\"string\"]," + "\"default\":null},{" + "\"name\":\"fieldDiscriminator\","
            + "\"type\":{" + "\"type\":\"enum\"," + "\"name\":\"FooOneofFieldDiscriminator\","
            + "\"symbols\":[\"oneofIntField\",\"oneofStringField\"]}" + " }]}]," + "\"default\":null}]}";
