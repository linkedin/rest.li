 ...
 *
 * provides an option to whether translate default field in Pegasus schema into an default or optional field in Avro
...
public enum PegasusToAvroDefaultFieldTranslationMode
{
   ...
   * <p>
   * <b>When used for Pegasus DataSchema to Avro Schema translation:</b>
   * Translate a field with default value in pegasus schema to a "optional" field in Avro schema
   * and with no default value specified, i.e. "null" is used as default
   * </p>
   *
   *
   * <p>
