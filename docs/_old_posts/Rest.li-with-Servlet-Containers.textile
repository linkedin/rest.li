...
Rest.li may be run in a variety of http frameworks.  Out of the box,  Rest.li supports both "Netty":Rest.li-with-Netty and Servlet containers, such as Jetty.
...
h2. Step 1. Creating a web.xml File
...
h5. file: example-standalone-app/server/src/main/webapp/WEB-INF/web.xml
...
For on the gradle 'war' plugin, see: "Gradle War Plugin":http://www.gradle.org/docs/current/userguide/war_plugin.html
...
dependencies {
  jetty8 "org.mortbay.jetty:jetty-runner:8.1.15.v20140411" // set to whatever version of jetty you want to test with
}
