...
public class TestURIMaskUtil
{
  ...
  {
    return new Object[][] {
      { "a:($*,=2)", "Malformed mask syntax: value specified for a non range parameter" },
      { "a:($*,b=5)", "Malformed mask syntax: value specified for a non range parameter" },
      { "a:($*,$start=-10)", "Malformed mask syntax: unexpected range value" },
      { "a:($*,$start=xyz)", "Malformed mask syntax: unexpected range value" },
