...
public class IllegalMaskException extends Exception
{
   ...
   */
  public IllegalMaskException(String message, Throwable cause)
  {
    super(message, cause);
  }
   ...
   * @param message the Exception message
   */
  public IllegalMaskException(String message)
  {
    super(message);
  }
   ...
   * @param cause the cause of the Exception
   */
  public IllegalMaskException(Throwable cause)
  {
    super(cause);
  }
