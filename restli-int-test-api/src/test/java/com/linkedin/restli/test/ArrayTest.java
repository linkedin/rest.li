 ...
 * If the request builder generator fails to generate Iterable<...> parameters, the class should fail to compile
 * Remove this test once the "items" field is completely obsolete
 *
 * @author Keren Jin
 */
